...
_Example:_ [matrix module](@nativescript/core/matrix)
...
_Example:_ [timer module](@nativescript/core/timer)
...
_Example:_ [image module](@nativescript/core/ui/image)
...
_Example:_ [file-system module](@nativescript/core/file-system) (_Note:_ `file-system-access` is the platform specific implementation)
