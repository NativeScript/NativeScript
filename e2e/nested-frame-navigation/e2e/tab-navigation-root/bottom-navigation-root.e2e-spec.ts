...
describe("tab-navigation-bottom-navigation-root", async function () {
    ...
    before(async function () {
        ...
        logWarn(`====== "bottom-navigation-root" ========`);
    ...
    for (let index = 0; index < transitions.length; index++) {
        ...
        describe(`bottom-navigation-root-transition-${transition}-scenario:`, async function () {
            ...
            it(`loaded BottomNavigation root with frames`, async function () {
                await screen[`navigateToBottomNavigationRootWithFrames`]();
                await screen[`loadedBottomNavigationRootWithFrames`]();
            });
