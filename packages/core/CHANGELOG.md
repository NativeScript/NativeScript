...
### [8.9.1](https://github.com/NativeScript/NativeScript/compare/@akylas/nativescript@8.9.0...@akylas/nativescript@8.9.1) (2025-02-17)
...
* `__ONLY_ALLOW_ROOT_VARIABLES__` to make `getCssVariables` 10x faster ([ccb1b08](https://github.com/NativeScript/NativeScript/commit/ccb1b086a9ea3aa586fb34f7aebb022396b47701))
* `defaultVisualState` to override 'normal' default visualState (for example to fake disabled state while allowing touch) ([a3fefbd](https://github.com/NativeScript/NativeScript/commit/a3fefbdbea3ea2d37fead389bb84ca3263d8d25a))
* `getAllJSON` and `getNative` for `ApplicationSettings` ([0b4f9f7](https://github.com/NativeScript/NativeScript/commit/0b4f9f7e6a31921f047ad80829fca7d73b479f88))
* `initRootView` event. ([009592a](https://github.com/NativeScript/NativeScript/commit/009592abd8132a9527b209c96b88d56b3880bcc6))
* allow native string (NSAttributedString / Spannable) to be set as text property for text base components ([699b420](https://github.com/NativeScript/NativeScript/commit/699b4200ef9a91d5a7dd73a4fcc97d866492b102))
...
* **android:** allow to set `SET_THEME_ON_LAUNCH` in app settings to override app theme ([8a6b9d4](https://github.com/NativeScript/NativeScript/commit/8a6b9d47fdeed28bc4da6f3354e51558db64514e))
...
* **android:** basic `sharedTransitionTags` for `SharedTransition` ([6780d8d](https://github.com/NativeScript/NativeScript/commit/6780d8dbb8ed99aacf515be25262a8ec419f1ec5))
...
* **android:** new `activityCreate` and `fragmentCreate` events ([33a1eb8](https://github.com/NativeScript/NativeScript/commit/33a1eb8fe34a4343b395444f5817ba9bc2c4f5f0))
...
* **core:** ignoreRegexp argument for `ApplicationSettings.getAllJSON` ([475239a](https://github.com/NativeScript/NativeScript/commit/475239a0da2ac6151350dda8e78af3b074b2177a))
...
* selectable property for editable text base. This allow NOT editable textview to still be selectable ([e701af4](https://github.com/NativeScript/NativeScript/commit/e701af489cb38aa49d406740bd33a9d142af7fcf))
...
*  always set the parent ([f7fe7e2](https://github.com/NativeScript/NativeScript/commit/f7fe7e2f39456bc2eb48a1909b45f5e6178db66d))
* `getAllJSON` now correctly returns number (though a bit too slow to my taste) ([9269988](https://github.com/NativeScript/NativeScript/commit/9269988037d6fe6b0897bd44a49ac65db2a57ff9))
* `getRequestedImageSize` fix ([58c8568](https://github.com/NativeScript/NativeScript/commit/58c856819f874162c75b8633385a04eda42835ae))
* `setAlpha` and other `Color` method were returing a `BaseColor` instead of a `Color` ([9816db1](https://github.com/NativeScript/NativeScript/commit/9816db1281428c5eabdf84fd5c6b30e2f6357647))
* accessibilityEnabled fix for for many views/plugins ([ae80498](https://github.com/NativeScript/NativeScript/commit/ae8049827fe47140fd1e31fa1d5a2772ac8d8827))
...
* allow `openUrl` to throw error ([9f44099](https://github.com/NativeScript/NativeScript/commit/9f440999922dbccc02726f5ced31f94248d30ffb))
* allow `openUrl` to throw error ([c1e7988](https://github.com/NativeScript/NativeScript/commit/c1e79885f14c5a31a74ae0409a793d82dc7f47f2))
* allow to cancel `systemAppearanceChanged` event. This can be usefull to override auto theme css update (like for true black mode) ([95b01ab](https://github.com/NativeScript/NativeScript/commit/95b01ab4a2b5595d55ff3d7072a6b85aa7afe4c7))
* **android:** `clipToBounds` was not working ([aa8ea81](https://github.com/NativeScript/NativeScript/commit/aa8ea81fb3a0afa36475141e64f7474dd3c43650))
* **android:** `openFile` correctly working with `content://` URLs ([625bbdf](https://github.com/NativeScript/NativeScript/commit/625bbdfe5770dbd1ae489af0b1bc58cdaff08518))
...
* **android:** added construtor parameter to `PageTransition` to allow changing the timeout use on page load to trigger transition. This can allow some components to be fully loaded and be able to query `sharedTransitionTag` ([b8f064e](https://github.com/NativeScript/NativeScript/commit/b8f064e4ea8b3b7d0c4f5927e0db2565dca9e174))
* **android:** allow custom transition on `goBack` ([e89d5cf](https://github.com/NativeScript/NativeScript/commit/e89d5cf3860e45cab118e0e52e2c8ee8583faa9b))
* **android:** allow to hide keyboard from a textfield which was part of a `PopupWindow`. ([825863b](https://github.com/NativeScript/NativeScript/commit/825863be9784da7af298a8758a475c9801ca7940))
* **android:** background/foreground events fix ([06f30b9](https://github.com/NativeScript/NativeScript/commit/06f30b928917b89325a1f2df22f85162393a3c8e))
* **android:** borderRadius / outlineProvider fix for borderRadius is changed back to 0 ([8e9dc44](https://github.com/NativeScript/NativeScript/commit/8e9dc44cce5f158ff7c5c4729ff67f2749d1ccfa))
* **android:** boxShadow vs clipToOutline fix ([2a059ca](https://github.com/NativeScript/NativeScript/commit/2a059ca63d9cfb33f82c904626411ee5aad8db1d))
* **android:** catch and throw errors in ApplicationSettings ([06f29e1](https://github.com/NativeScript/NativeScript/commit/06f29e11210639beb5a5a7f662501b2ec4e66897))
* **android:** complete native error wrapping for fileSystem ([cb192d3](https://github.com/NativeScript/NativeScript/commit/cb192d3ba9f2403295d15a02826e509aee33fa91))
* **android:** default clipping is true ([5bd5a68](https://github.com/NativeScript/NativeScript/commit/5bd5a685c068fc5094f619fd59cd451eb30ee3dc))
...
* **android:** dont resize image in ImageAsset loading ([7753966](https://github.com/NativeScript/NativeScript/commit/775396662c0f7d33d66851fea33d10837fed8d2b))
* **android:** dont set fontInternal after fontSize for text-base. Useless ([ab6f4f6](https://github.com/NativeScript/NativeScript/commit/ab6f4f638f7de0e2ebb161219f004ae0774d17ee))
* **android:** faster visibility property ([ff39c63](https://github.com/NativeScript/NativeScript/commit/ff39c632d0a9f7b3f61877aae45308f7fbb94327))
* **android:** file-system now support content:// all the way ([c32c556](https://github.com/NativeScript/NativeScript/commit/c32c5563f8cc39c7ff74be30cf77e7a8ba3b538b))
* **android:** goBack fix after activity recreated ([3d446ea](https://github.com/NativeScript/NativeScript/commit/3d446eae627a2d2f881490862883c2f2607ac5db))
...
* **android:** more transition fixes ([781a718](https://github.com/NativeScript/NativeScript/commit/781a7187db116003a6fad7522125c4f7e722aa20))
* **android:** native api usage fix for shared element transitions ([74478e1](https://github.com/NativeScript/NativeScript/commit/74478e132da75e75850f1001b1bc330033ff1e6a))
* **android:** prevent error if rootView not mounted (though not sure how it could be happening) ([acc0b20](https://github.com/NativeScript/NativeScript/commit/acc0b204697d5c035bbc409f73b71d6140dc5eb4))
...
* **android:** prevent error while navigation back after using page transition ([a6c6fce](https://github.com/NativeScript/NativeScript/commit/a6c6fcecfaa979bd28566344930bc2847ddba215))
...
* **android:** prevent error while opening modal from background. Also added `android.showImmediatelyFromBackground` to force commit from background (though it does not seem to have a UX difference) ([a15edd7](https://github.com/NativeScript/NativeScript/commit/a15edd729b6fc138ba29d886cee24f0ee0313ce8))
* **android:** prevent infinite loops text-base change event ([42ee720](https://github.com/NativeScript/NativeScript/commit/42ee7201a9a287fef51dbdb83df7d423733d7619))
...
* **android:** regression after refactoring of Font ([64bb23d](https://github.com/NativeScript/NativeScript/commit/64bb23de54707ad9184aa1c9628f60aba31eddbe))
* **android:** regression where editing textfield would move the cursor to the end on every change ([61a724e](https://github.com/NativeScript/NativeScript/commit/61a724ef92e91064f0cbb7f5d3991325e71172e4))
* **android:** return native error or we loose stack ([f28141d](https://github.com/NativeScript/NativeScript/commit/f28141df956d921d2884534efc9e1b97152b8aa7))
* **android:** rewrite the GridLayout to make as less JNI calls as possible ([06df4fa](https://github.com/NativeScript/NativeScript/commit/06df4fa0beaeba8544e858212cc7c2a7482af0eb))
* **android:** shared element transition not working ([2a3fd1d](https://github.com/NativeScript/NativeScript/commit/2a3fd1d854bf46762020a4cad07fc9267d53a0ba))
...
* **android:** trick to get a stack on native exceptions ([9aa5e76](https://github.com/NativeScript/NativeScript/commit/9aa5e76c13aed59cfc9f085e2bbb1f88d5131959))
* **android:** unload/load pages while navigating forward then back ([879dd2a](https://github.com/NativeScript/NativeScript/commit/879dd2af3792ec701ceddc6b4452152c519326bc))
...
* **android:** wrapNativeException fix for string errors ([4229f46](https://github.com/NativeScript/NativeScript/commit/4229f463590f2bc70be0a8d5e7a387ae58aa4f7d))
* **android:** wrong parameters to force hiding keyboard ([9329ac1](https://github.com/NativeScript/NativeScript/commit/9329ac1d612e610b62e5b0165e0a25849b85dd88))
* Application `once` method fix (was not removed after first event) ([1c3b5c8](https://github.com/NativeScript/NativeScript/commit/1c3b5c8ed394f30201ef30fcf8fe69bc73f33cdb))
* better handle KeyFrameAnimation errors ([da206a1](https://github.com/NativeScript/NativeScript/commit/da206a12cdeadff47841ac0ec27a39ae926e9656))
* better typings for `getEntities` method in filesystem ([5e2d909](https://github.com/NativeScript/NativeScript/commit/5e2d9098e0c26a1c616384c22f0d1e60b269d4f6))
* bring back global event listeners (used for sentry) ([08f4896](https://github.com/NativeScript/NativeScript/commit/08f48962fbf21d0df523054581525c11f79f2280))
...
* cleanup the modal parent once closed. ([82d473c](https://github.com/NativeScript/NativeScript/commit/82d473c7adf55a31ee332c11e051807a839bd395))
...
* **core:** android support SAF from android 21 ([b3439c7](https://github.com/NativeScript/NativeScript/commit/b3439c75f7559edcc62dc37cdac85b7ec844f1f2))
...
* **core:** ios ensure animation finish is always called ([0084c70](https://github.com/NativeScript/NativeScript/commit/0084c7083ca31d025140700bf0e99fea5ac0f811))
* **core:** ios fix for `File.fromPath` with a path starting with `file://` ([2b35967](https://github.com/NativeScript/NativeScript/commit/2b35967c31088127d5cbe0692d9d288960c2816e))
* **core:** ios fix for animating boxShadow ([cdee533](https://github.com/NativeScript/NativeScript/commit/cdee5338f17dea8e98e61a9374e6cf76a6a6ab2c))
* **core:** ios fix for fontScale not applied ([1d955f9](https://github.com/NativeScript/NativeScript/commit/1d955f9724f2a19b31d6edc27baa7a6fcb5cc6ac))
* **core:** iOS prevent _addViewToNativeVisualTree from _setupAsRootView ([21f1a0f](https://github.com/NativeScript/NativeScript/commit/21f1a0fa8719bdfe4a13720107e9b733b07ae8c1))
...
* defer `_onCssStateChange` for unloaded views. It will be called once the view is loaded again ([c278eed](https://github.com/NativeScript/NativeScript/commit/c278eedbd6b487b23ca3e19337460c8a6e11546c))
* disable accessibilty for layout views. Seems unecessary and can be enabled on a per view basis ([deed2ef](https://github.com/NativeScript/NativeScript/commit/deed2ef1479ef040b390d89a624940c09b3b814f))
...
* ensure _resolvedPage is always correct. Would make eachChild not work after navigation ([84308eb](https://github.com/NativeScript/NativeScript/commit/84308ebc263d35fef7e2f188fc4c42dc6c0fdb60))
* ensure parent is a frame (it might not be) ([b1df9af](https://github.com/NativeScript/NativeScript/commit/b1df9af43255512f83d9193384478ee501ed06f7))
* ensure subRootView dont have a parent ([459ee4f](https://github.com/NativeScript/NativeScript/commit/459ee4f8f5413b9e4112b2af6515b1110af58c1e))
* fix for classes handling fontSize without setting fontInternal (faster) ([e42c32e](https://github.com/NativeScript/NativeScript/commit/e42c32e3b0bcae01236eb1773dddd72f662f36d7))
* for now fix `requestAnimationFrame` to work with svelte ([bd75a56](https://github.com/NativeScript/NativeScript/commit/bd75a56b18cdc32af48721ef17db627c54deb3df))
...
* handle navigation error to not break future navigation calls ([dceea2e](https://github.com/NativeScript/NativeScript/commit/dceea2e16bf65da58785e2ecdc8b9c5a9bab06b9))
* improved `wrapNativeException` method ([70a7052](https://github.com/NativeScript/NativeScript/commit/70a70522caae890406c858c4d4a915417decb450))
* inspector_modules ([ae62725](https://github.com/NativeScript/NativeScript/commit/ae6272551099cf1a851b64b0f4b64145a70adb54))
* **ios:** `ImageAsset` `getImageAsync` fix to return correct image size ([3ddbf66](https://github.com/NativeScript/NativeScript/commit/3ddbf66229d8454575b92d917e6536ec877cbb81))
...
* **ios:** big animations fix ([961d355](https://github.com/NativeScript/NativeScript/commit/961d35569a30a1da825d7f13ed83b985459904e3))
* **ios:** broken transform if set before any layout ([de39741](https://github.com/NativeScript/NativeScript/commit/de397414854f4313608b29973df0eb4570835738))
* **ios:** can now show modal on top of each other ([32f7dce](https://github.com/NativeScript/NativeScript/commit/32f7dceaa0cd19ed4fbc5cb50a9e27a96439c5c4))
* **ios:** clipToBounds default fix ([17757a0](https://github.com/NativeScript/NativeScript/commit/17757a0aefbf1007cd2d2295389654ed2733ce5a))
* **ios:** correctly load Frame in modal ([4207b03](https://github.com/NativeScript/NativeScript/commit/4207b034f0f8919cfb9f032ab92a776cd05b09b7))
* **ios:** dialogs allow to show over already presented controllers. ([9236f06](https://github.com/NativeScript/NativeScript/commit/9236f06e6834637766fab569c698a1cd0556c7b6))
* **ios:** ensure children can request layout after suspension ended in `onLoaded` ([3e1350d](https://github.com/NativeScript/NativeScript/commit/3e1350d2ad161fe92752eef2c3dba0436275da49))
* **ios:** fixed opacity not animating anymore ([27207e7](https://github.com/NativeScript/NativeScript/commit/27207e7155a4f15fe663018e80919c4acc14a924))
...
* **ios:** now view animation are stacked into one animate block when possible ([a065bfe](https://github.com/NativeScript/NativeScript/commit/a065bfeaf48d5f74aee5cd01f1ca750342620b11))
* **ios:** openFile working when called from a modal ([848a8b9](https://github.com/NativeScript/NativeScript/commit/848a8b93079f56eda1192634205ce74f63f634c3))
* **ios:** persist animation after it ends ([afec0d7](https://github.com/NativeScript/NativeScript/commit/afec0d78dc51c520ee0765b5f5be596ef989c772))
* **ios:** prevent animation while changing background effects ([43a32d4](https://github.com/NativeScript/NativeScript/commit/43a32d4e8f20271ed8cd60f416b985d40866b7fe))
* **ios:** prevent not wanted changes to be animated ([c57548c](https://github.com/NativeScript/NativeScript/commit/c57548cd5c058c51d22f6b71e622c4843ac6b56e))
...
* **ios:** px properties parsing fix ([c8174a7](https://github.com/NativeScript/NativeScript/commit/c8174a7ba2f1b726cf6e97278ab2cad40e451f0a))
* **ios:** regression from 8.7.0 ([9f7d741](https://github.com/NativeScript/NativeScript/commit/9f7d7418c091423f56cea7576cb3c91b6738b5b2))
* **ios:** report error in animate if view is not init ([5053704](https://github.com/NativeScript/NativeScript/commit/50537049586e3df00d2f253bd3b9d6100d37e533))
...
* **ios:** use `requestlayoutIfNeeded` ([7630be5](https://github.com/NativeScript/NativeScript/commit/7630be5de435d14e600e012e6bc69b003fffdf4e))
* **ios:** view not performing layout in some cases ([1ab2d99](https://github.com/NativeScript/NativeScript/commit/1ab2d99eef80fa6cd9421a8db629a73439d03dde))
* **ios:** working `ApplicationSettings. getAllJSON` ([9779af4](https://github.com/NativeScript/NativeScript/commit/9779af48be77da6fd19176f5f73ce276ddbc20b4))
* isLoaded default to false and not undefined ([4339484](https://github.com/NativeScript/NativeScript/commit/43394847e910f4e1051d9ccbc0937ed91acd587f))
* leading support for debounce ([fac52be](https://github.com/NativeScript/NativeScript/commit/fac52beac1983b43819c9a030556a07ee7bd0a85))
* maxWidth/maxHeight support for ImageAsset ([1582b05](https://github.com/NativeScript/NativeScript/commit/1582b05579f277613ba54f37b72a86f57c8501fe))
* modal dialog root view now has the `rootView` as parent to be able to access the `ns-root` class which comply with css specs (for example to read root css variables) ([4730904](https://github.com/NativeScript/NativeScript/commit/473090434fa916ba29c85f0c4ded86a8247b81c0))
* more debounce options ([12d2cd8](https://github.com/NativeScript/NativeScript/commit/12d2cd8370df7de77282cfc6529d295a59e362fa))
* Observable only support one event name now ([b9d5ba1](https://github.com/NativeScript/NativeScript/commit/b9d5ba1c53987a7bbc3a8430b327c96dac03eb8c))
* prevent breaking modal stack ([f90b043](https://github.com/NativeScript/NativeScript/commit/f90b0432b75ca98efce3ba1d4d56da2fc2a6dc91))
* prevent crash if style property is malformed ([9140382](https://github.com/NativeScript/NativeScript/commit/9140382e4712c6b4707c544c82e3eafd3a63ac57))
* prevent error with unneeded `_resumeNativeUpdates`. It can happens if a view is created while in batchUpdate ([9140b17](https://github.com/NativeScript/NativeScript/commit/9140b1736947b247de4af67adc9717a2cf2c2250))
* prevent property change event while batch update or onLoaded ([05ac9ea](https://github.com/NativeScript/NativeScript/commit/05ac9ea21a79ac3f843080d1d61926448fe9717d))
* print error stack when possible ([5d87404](https://github.com/NativeScript/NativeScript/commit/5d874046bbd792a5b7f000be1e876f5bb8d7caa4))
* profile decorator fix ([e8a9a5b](https://github.com/NativeScript/NativeScript/commit/e8a9a5bfee638e558e33539c5c10b124ff02c136))
* regression fix for [#10482](https://github.com/NativeScript/NativeScript/issues/10482) ([#10518](https://github.com/NativeScript/NativeScript/issues/10518)) ([92b2ff8](https://github.com/NativeScript/NativeScript/commit/92b2ff83a038ece4ab4411cf983ee9e252bba141))
* regression fix on `PercentLength.toDevicePixels` ([f619c54](https://github.com/NativeScript/NativeScript/commit/f619c54908f789772f1596d54fdae62ed84b23e2))
* remove maxSize thing from `ImageAsset.getImageAsync` as it is useless and impossible to "disable" ([8f809be](https://github.com/NativeScript/NativeScript/commit/8f809beb3120944d6b5baf8002acec79686d57f7))
* rollback on some requestLayout optimisations ([d5aa194](https://github.com/NativeScript/NativeScript/commit/d5aa1949758a895eab39b3b39d2b9a840ff940af))
* rootView is now a GridLayout and "user" rootView is added to it. That way when the "user" rootView is initiated it already has access to `.ns-root` and its variables ([5161bb3](https://github.com/NativeScript/NativeScript/commit/5161bb38f9b312f49aabebf5fb25c632620d318a))
* rotate key frame animation fix ([f11ef85](https://github.com/NativeScript/NativeScript/commit/f11ef851ff1c2023aafb0e37d0fcdf0e33e6cbe0))
* shared element transition now working with ListView/CollectionView/Pager ([a49e0db](https://github.com/NativeScript/NativeScript/commit/a49e0dbf0ec17bfe555ab2af3d6242dda644edee))
...
* verticalAligment prop validated using its own type ([1cb6375](https://github.com/NativeScript/NativeScript/commit/1cb637548034a7ca234a233040959b8dff921b24))
...
* working if FormData is not defined ([69084cb](https://github.com/NativeScript/NativeScript/commit/69084cbd839afe976590760659c6ffce2394140e))
* wrong import fixes ([a287c95](https://github.com/NativeScript/NativeScript/commit/a287c952e8c85a90ca8e56ba2685ad13d4661870))
...
* Revert "Auxiliary commit to revert individual files from a961a1c6a8ceb38802fdba9c9988c89286a3c50c" ([5f511e4](https://github.com/NativeScript/NativeScript/commit/5f511e4c4b94778bd033b1ee57b02ea39505fbba))
* "fix(android): proper change of input interaction mode programmatically ([#10434](https://github.com/NativeScript/NativeScript/issues/10434)) ([#10512](https://github.com/NativeScript/NativeScript/issues/10512)) ([873f711](https://github.com/NativeScript/NativeScript/commit/873f711a6b2c7b3ca50142f434cde49a2f2ebf49))
...
* **file-system:** append, appendText & createFile ([#10285](https://github.com/NativeScript/NativeScript/issues/10285)) ([ab32aea](https://github.com/NativeScript/NativeScript/commit/ab32aeaaa3715e5178f349646f14a632c771ce61))
...
* **android:** native api usage fix after last changes ([5267a1f](https://github.com/NativeScript/NativeScript/commit/5267a1f34cad045a0c0c81f15764ca40ba3e831e))
...
* **core:** android fix for EditableText cursor being placed correcly after text change ([525e65e](https://github.com/NativeScript/NativeScript/commit/525e65e6cbf49756d9e5314131b318f16c1c4e6c))
...
* early access to context and packageName ([#10321](https://github.com/NativeScript/NativeScript/issues/10321)) ([0873894](https://github.com/NativeScript/NativeScript/commit/0873894a27cc2785c9b1db189d63e2cd2e2c60f7))
...
* **ios:** prevent usage of viewControllers that are being dismissed ([#10291](https://github.com/NativeScript/NativeScript/issues/10291)) ([963d024](https://github.com/NativeScript/NativeScript/commit/963d0243de8b230a57da4ce0e0f7a742ac61901d))
* **root-layout:** check type for translate and scale values ([#10288](https://github.com/NativeScript/NativeScript/issues/10288)) ([874f6b6](https://github.com/NativeScript/NativeScript/commit/874f6b6e65f79cd2723f5dcad405905381b122cb))
...
* ios animation fix for completion block being called too soon ([7faa62e](https://github.com/NativeScript/NativeScript/commit/7faa62e3a9c7fa3248b6f534e779c92584697069))
...
* "fix(core/platform): fixed types for sdkVersion and osVersion" ([#10270](https://github.com/NativeScript/NativeScript/issues/10270)) ([71c42f3](https://github.com/NativeScript/NativeScript/commit/71c42f3a194ecda5130e74f19f9494afc66953d8)), closes [#10269](https://github.com/NativeScript/NativeScript/issues/10269)
...
* **android:** improved native-api-usage after removing *. ([7fa6c9b](https://github.com/NativeScript/NativeScript/commit/7fa6c9b13f27bb137103b57304cb495f326c10ef))
...
* **android:** missing native-api-usage ([7aa89fa](https://github.com/NativeScript/NativeScript/commit/7aa89fa0ac1c0d5e807d6feab0b386288b7d3089))
* **android:** native-api-usage fix after last changes ([3713da0](https://github.com/NativeScript/NativeScript/commit/3713da059fb4fbf9a3ddee07bab3d76921197e35))
...
* **core:** android native-api-usage fix ([0b0cbe3](https://github.com/NativeScript/NativeScript/commit/0b0cbe313f0ac6fde621e60ccd7396754f02a335))
* **core:** android native-api-usage fix ([db6dce1](https://github.com/NativeScript/NativeScript/commit/db6dce13bfce060adbf0985acdef949a044892b3))
* **core:** android removed native TextTransform as it seems to be unused ([f3229e4](https://github.com/NativeScript/NativeScript/commit/f3229e44abff1cb1895561ae35ab14a7f8f2afb0))
* **core:** android wrap init in trycatch to get possible error ([d863d61](https://github.com/NativeScript/NativeScript/commit/d863d61228167eb1acd12311f83a829f124869e7))
...
* **core:** improved native-api-usage ([25febb8](https://github.com/NativeScript/NativeScript/commit/25febb82954b71c4faf7f0326aaacb448a5f9898))
* **core:** native-api-usage fixes ([0007cc2](https://github.com/NativeScript/NativeScript/commit/0007cc2a7de65380e018557efd3ba0c7a8bf67ae))
...
* **core:** remove unnecessary set of native text value change for formattedText ([5179f13](https://github.com/NativeScript/NativeScript/commit/5179f13f1609f86ecfb000a724c2a3cead906336))
...
* ensure debugger code is removed in production ([9b82614](https://github.com/NativeScript/NativeScript/commit/9b82614df2d225238a17459d7ea6e5ad79120a42))
* global declarations fix ([0859ce4](https://github.com/NativeScript/NativeScript/commit/0859ce445042877af29f5b077b4be27b68ca2d84))
...
* make span set text faster ([f90df18](https://github.com/NativeScript/NativeScript/commit/f90df1821b29f4c1f37c97ac7a7b9686fab1f519))
* remove hacks from https://github.com/NativeScript/NativeScript/pull/10164 and https://github.com/NativeScript/NativeScript/pull/10044 ([c50b4df](https://github.com/NativeScript/NativeScript/commit/c50b4df83e59a23c1106d4138e7c20155aa1901a))
* store old inlineStyle to allow reset of value if inlineStyle changes ([b76b08f](https://github.com/NativeScript/NativeScript/commit/b76b08f22a5e07cc98aede183d50fc197ae0cbcf))
...
* "chore: ios relayout condition cleanup ([#10241](https://github.com/NativeScript/NativeScript/issues/10241))" ([8da1ca9](https://github.com/NativeScript/NativeScript/commit/8da1ca910a4d7ab39d0af4b52c58fcd82b8393f6))
...
* missing typings for intellisense ([fca4455](https://github.com/NativeScript/NativeScript/commit/fca4455b2e684aa405cbd9a3a51b91238cb11215))

## 8.4.4-core (2023-01-09)

### Features

* **core:** new autoFillTypes ([33bae2f](https://github.com/NativeScript/NativeScript/commit/33bae2f19267150b34091a9f7551255d95c620a2))
...
* **core:** `knownFolders.externalDocuments()` ([1a019e1](https://github.com/NativeScript/NativeScript/commit/1a019e1f288c74d41397cf69aa39e4ae39e10405))
...
* **files:** knownFolders.externalDocuments for android ease of use ([#9966](https://github.com/NativeScript/NativeScript/issues/9966)) ([e51e945](https://github.com/NativeScript/NativeScript/commit/e51e9454006f19d15495ec4946455f5b8f7c1acc))
...
* **mac:** support for Mac Catalyst with ui-mobile-base ([cd69379](https://github.com/NativeScript/NativeScript/commit/cd69379b8967ba1ea39f0272b003ffda09b4b8e2))
...
* **Utils:** add dataSerialize and dataDeserialize for iOS ([2250c7f](https://github.com/NativeScript/NativeScript/commit/2250c7fc6afb913762228441755f28c5dcab7fe6))
...
* `externalDocuments` fix ([40ed258](https://github.com/NativeScript/NativeScript/commit/40ed2588219c124d5b783d1c5676676f78ce761a))
* allow animation of any prop ([1f6d428](https://github.com/NativeScript/NativeScript/commit/1f6d428bf86c1feeaf2afe245bef9653cf8d0ca7))
...
* **android:** content uri handling improvements ([#9936](https://github.com/NativeScript/NativeScript/issues/9936)) ([99480c0](https://github.com/NativeScript/NativeScript/commit/99480c06db1debb9eeb6cae21702eb83ef9e4dd5))
* **android:** content uri handling improvements ([#9936](https://github.com/NativeScript/NativeScript/issues/9936)) ([7bbb77a](https://github.com/NativeScript/NativeScript/commit/7bbb77ad8641d2bb03a93d7df6b77ab305aa2eba))
* **android:** CSS style not working properly in modal pages ([#10070](https://github.com/NativeScript/NativeScript/issues/10070)) ([608d3b9](https://github.com/NativeScript/NativeScript/commit/608d3b929608ab2c3b4c22a0f1ce7f2e861434c9))
...
* **android:** FragmentClass memory leak ([#9973](https://github.com/NativeScript/NativeScript/issues/9973)) ([59f9235](https://github.com/NativeScript/NativeScript/commit/59f923528d2560a1c1751ecb9048f9498fdd3798))
...
* **android:** race condition on offBackgroundColor view change detection ([#9922](https://github.com/NativeScript/NativeScript/issues/9922)) ([464ea18](https://github.com/NativeScript/NativeScript/commit/464ea18737dc5976f66e0f5eee7dd0c66fe2a694))
...
* **android:** text transform capitalize is capitalizing after apostrophe ([#10029](https://github.com/NativeScript/NativeScript/issues/10029)) ([e3255c0](https://github.com/NativeScript/NativeScript/commit/e3255c00d88d251174b109fbadaa5345e23393f3))
...
* **android:** WeakRef race condition on timers ([#10066](https://github.com/NativeScript/NativeScript/issues/10066)) ([1a5faec](https://github.com/NativeScript/NativeScript/commit/1a5faecba0b0c9194cc0d3924edc5df5edcb21a7))
* **android:** webview href schemes threw 'net::ERR_UNKNOWN_URL_SCHEME' ([#10048](https://github.com/NativeScript/NativeScript/issues/10048)) ([655f3a4](https://github.com/NativeScript/NativeScript/commit/655f3a45c1179088863c8304fd6d72df657ec013))
* **animations:** error handling ([36ad24c](https://github.com/NativeScript/NativeScript/commit/36ad24c037ea06111beb4176bb3836a319307b81))
* **builder:** property parentsMatch is invalid or does not exist ([#10020](https://github.com/NativeScript/NativeScript/issues/10020)) ([405904c](https://github.com/NativeScript/NativeScript/commit/405904c5428078290c771acdaa7d4b866ca1c8e7))
...
* **core:** (TESTING) ensure getRootView always return the correct view ([2d5848e](https://github.com/NativeScript/NativeScript/commit/2d5848eaa8e5ef70cf321f490febd9b3e54d31b0))
* **core:** `systemAppearance` fix for when called early ([e245f81](https://github.com/NativeScript/NativeScript/commit/e245f81a22b0f50793f8a39a2b02887470fb4e1f))
...
* **core:** allow passing fontWeight as a number ([c8e3e54](https://github.com/NativeScript/NativeScript/commit/c8e3e54f2dc06a1e0c5089224bc3a2e9bd78d5b0))
...
* **core:** android fix for `knownFolders.externalDocuments()` in some cases (emulator) ([b872b8a](https://github.com/NativeScript/NativeScript/commit/b872b8aadc56475095ef7b1305f8a07c11fb2a84))
* **core:** android fix for `path.normalize` ([835857c](https://github.com/NativeScript/NativeScript/commit/835857c49b592e480f446e4d984871c698db4961))
* **core:** android native-api-usage ([e11be2e](https://github.com/NativeScript/NativeScript/commit/e11be2eea9a83a0e46363e2023fb880647f4d534))
* **core:** android native-api-usage add missing for ImageSource ([6465aac](https://github.com/NativeScript/NativeScript/commit/6465aac922aef7c3d93192ea371f2694cde1464a))
* **core:** android native-api-usage fix after merge ([42be033](https://github.com/NativeScript/NativeScript/commit/42be03300a22ed6f0e0fb13d23f1049320ac61c9))
* **core:** android refactor EditableTextBase to allow sub classes to change/augment ([e306cbb](https://github.com/NativeScript/NativeScript/commit/e306cbbe93654681107cde0ae0498777efadb426))
...
* **core:** correctly normalize path on all android versions ([e4f8ce0](https://github.com/NativeScript/NativeScript/commit/e4f8ce0ef8a1ff50c48d41ac9dcf5e3c5bff8e3c))
...
* **core:** ensure we clear the webview client on android ([dad92a4](https://github.com/NativeScript/NativeScript/commit/dad92a4d7e713ab6a79229b4c7f65d1d9508f0a0))
* **core:** errors get swallowed if thrown inside async event functions ([#10030](https://github.com/NativeScript/NativeScript/issues/10030)) ([bdade0f](https://github.com/NativeScript/NativeScript/commit/bdade0f0d5bbe2fdbce0b697741a748a16f6137c))
...
* **core:** Frame `navigatingToEvent` event fix ([265a575](https://github.com/NativeScript/NativeScript/commit/265a575602a8cad7fec73fec65fc9f5a0680f51f))
* **core:** import fix ([45dcada](https://github.com/NativeScript/NativeScript/commit/45dcada01ab6f44d7fdc9d28f3b40ce1015053bc))
* **core:** ios fix tap gesture not working ([0024bb7](https://github.com/NativeScript/NativeScript/commit/0024bb79c356570d8f69454ed52c0c315a09aea8))
* **core:** iOS Frame `navigatingTo` event not fired ([8c54a8b](https://github.com/NativeScript/NativeScript/commit/8c54a8b9f3b57f0a6a290927f7125f3b4128fa5d))
...
* **core:** missing export for `maxLinesProperty` ([#9965](https://github.com/NativeScript/NativeScript/issues/9965)) ([c8bff74](https://github.com/NativeScript/NativeScript/commit/c8bff74e6712a286a335716c49255af6023157fb))
* **core:** missing export for maxLinesProperty ([e7091c4](https://github.com/NativeScript/NativeScript/commit/e7091c4d831e10f197f5532151099a86da211931))
* **core:** modal css apply fix ([90ba69b](https://github.com/NativeScript/NativeScript/commit/90ba69b8ab4b2f51ad412a833ec0541c55c644ff))
...
* **core:** prevent a circular reference because of `SDK_VERSION ([318bc1a](https://github.com/NativeScript/NativeScript/commit/318bc1adc3e771935286a473d04d0cfc72f7afed))
...
* **core:** prevent actionBar being created if not used ([c634b3c](https://github.com/NativeScript/NativeScript/commit/c634b3c5a3d2459f168744eee353ad0079eb5eb1))
* **core:** prevent actionBar being created if not used ([0f897d4](https://github.com/NativeScript/NativeScript/commit/0f897d4d9953bd361b028349dbee482f74500a8d))
...
* **core:** try to prevent unwanted requestLayout on views creations ([1f1987f](https://github.com/NativeScript/NativeScript/commit/1f1987fe34ea682b38b975ad2b8fb254809b63f1))
...
* **core:** WeakRef typings to include deref ([#10006](https://github.com/NativeScript/NativeScript/issues/10006)) ([3bf1640](https://github.com/NativeScript/NativeScript/commit/3bf164073bc1dc941ea5d33df74059afc6107c93))
...
* dont apply system classes in `className`. It will be handled through css scopes ([908ef16](https://github.com/NativeScript/NativeScript/commit/908ef1667b29d52bcf1fca8f3c7b3d778b3893b9))
...
* ensure we still remove views from native tree if they dont have an N parent ([2c8f6ad](https://github.com/NativeScript/NativeScript/commit/2c8f6addb30bacfd1e4d2cebae1070467afdde45))
...
* fix back accessibility while only activating it when necessary ([ff5c53b](https://github.com/NativeScript/NativeScript/commit/ff5c53b5c85425236ddece2c1608c293302ae386))
...
* **ios:** ensure `PFLAG_FORCE_LAYOUT` before `performLayout` ([#10011](https://github.com/NativeScript/NativeScript/issues/10011)) ([e7e3bd2](https://github.com/NativeScript/NativeScript/commit/e7e3bd2bb0bab02026508c0eb6722c5bda8081b4))
...
* **ios:** ensure view layout when using large titles ([#10044](https://github.com/NativeScript/NativeScript/issues/10044)) ([d625141](https://github.com/NativeScript/NativeScript/commit/d625141c4271293835e4d53c72d1f19a07388671))
...
* **ios:** guard accessing actionbar ([#10033](https://github.com/NativeScript/NativeScript/issues/10033)) ([1c82d19](https://github.com/NativeScript/NativeScript/commit/1c82d194557e3aa6f29cba34a10af540eda7e37d))
* **ios:** handle tap and longpress gesture conflict ([#10004](https://github.com/NativeScript/NativeScript/issues/10004)) ([64755cb](https://github.com/NativeScript/NativeScript/commit/64755cb348b316fa80534275c4c72843ba1cc902))
...
* **ios:** label measure correct height when using custom numberOfLines ([#9945](https://github.com/NativeScript/NativeScript/issues/9945)) ([441d1b4](https://github.com/NativeScript/NativeScript/commit/441d1b4c0f48cf0d0b79c8599b4e1fe2a4ca1d9d))
...
* **ios:** memory leak after using 'showModal' passing any Page as parameter ([#9939](https://github.com/NativeScript/NativeScript/issues/9939)) ([0631f49](https://github.com/NativeScript/NativeScript/commit/0631f49f44f5b57f47afdc4e66e552788999f709))
...
* **ios:** memory leak after using the 'presentViewControllerNavigation' ([#9934](https://github.com/NativeScript/NativeScript/issues/9934)) ([edc2e6a](https://github.com/NativeScript/NativeScript/commit/edc2e6a5de3a02a6032d78efb4252ebd9202a6d0))
* **ios:** page isRunningLayout ([#10078](https://github.com/NativeScript/NativeScript/issues/10078)) ([614dafb](https://github.com/NativeScript/NativeScript/commit/614dafb42bd94c79adfba4d96143ae8b4d862403))
* **ios:** prevent creating `ActionBar` when not needed ([#10017](https://github.com/NativeScript/NativeScript/issues/10017)) ([fc6f843](https://github.com/NativeScript/NativeScript/commit/fc6f843fdaa19927286003516401167c237b1a54))
...
* **ios:** properties lineHeight and letterSpacing did not apply to spans ([#10025](https://github.com/NativeScript/NativeScript/issues/10025)) ([e4b5cdf](https://github.com/NativeScript/NativeScript/commit/e4b5cdf7df86be9d0ea2730438e134bdaf1c3a1a))
* **ios:** segmented bar nativeView check ([#10023](https://github.com/NativeScript/NativeScript/issues/10023)) ([1ad8099](https://github.com/NativeScript/NativeScript/commit/1ad8099cd84dd1cd38d2b06d9996e9a438a41277))
...
* **ios:** tab page navigation when showing dialog messages ([#10075](https://github.com/NativeScript/NativeScript/issues/10075)) ([0f7e4ed](https://github.com/NativeScript/NativeScript/commit/0f7e4ed0f30e9dfbde129b5f3ae648a15946bcf5))
* **ios:** tapping on span does not emit linkTap event ([#10028](https://github.com/NativeScript/NativeScript/issues/10028)) ([ab3416d](https://github.com/NativeScript/NativeScript/commit/ab3416d4d0175a42f4f28978b01f6ca581c7b82d))
...
* **RootLayout:** resilience around shadeCover options ([91df89e](https://github.com/NativeScript/NativeScript/commit/91df89e2744ecb09af81ad3142702eafe4a11dbc))
...
* wrong prop ([0b29254](https://github.com/NativeScript/NativeScript/commit/0b2925405a5ae7a4a5cd884e0a60fd34c1cf105c))
...
* cache UIFont construction based on FontDescriptor ([#9948](https://github.com/NativeScript/NativeScript/issues/9948)) ([c2cbfa5](https://github.com/NativeScript/NativeScript/commit/c2cbfa544fb5843be92db59c1e28a2981508baa5))
...
* faster style-scope setPropertyValues ([#9083](https://github.com/NativeScript/NativeScript/issues/9083)) ([9ccc54b](https://github.com/NativeScript/NativeScript/commit/9ccc54b6035c04e383d9256fb3ad9c0c7b00fa20))

### Reverts

* revert "fix(core): handle tap and longpress gesture conflict on iOS" (#10021) ([9972946](https://github.com/NativeScript/NativeScript/commit/99729465517c06657fde604e8c1a5c9367323a9b)), closes [#10021](https://github.com/NativeScript/NativeScript/issues/10021) [#10004](https://github.com/NativeScript/NativeScript/issues/10004)
* "fix(ios): apply proper border radius to box shadow and view sublayers ([#9881](https://github.com/NativeScript/NativeScript/issues/9881))" ([#9917](https://github.com/NativeScript/NativeScript/issues/9917)) ([50fd3c0](https://github.com/NativeScript/NativeScript/commit/50fd3c06f803dc717dd4ac849b39eb985f108e51))
...
* **application:** expose `inBackground` and `suspended` ([#9897](https://github.com/NativeScript/NativeScript/issues/9897)) ([f509b3f](https://github.com/NativeScript/NativeScript/commit/f509b3ff1b54617eb314c88cedce8cb64badcb05))
* **core:** `maxLines` support for all text components ([2a4d2fa](https://github.com/NativeScript/NativeScript/commit/2a4d2faf09eeabe74bb5fbfede145787b4f5724f))
* **core:** `maxLines` support for all text components ([89a0b86](https://github.com/NativeScript/NativeScript/commit/89a0b866a8272637171469e10120bb9a33063f78))
* **core:** maxLines support for all text components ([#9884](https://github.com/NativeScript/NativeScript/issues/9884)) ([df10ceb](https://github.com/NativeScript/NativeScript/commit/df10ceb4916502ad95057b6c846056eb0400c400))
* **ios:** Utils.getRootViewController ([600cb08](https://github.com/NativeScript/NativeScript/commit/600cb087ef5d070497f94671d11f827559144149))
* **RootLayout:** add opened and closed events ([#9893](https://github.com/NativeScript/NativeScript/issues/9893)) ([8aee22b](https://github.com/NativeScript/NativeScript/commit/8aee22bda379358f07b0d4b7574b6d8ed02a170d))
* **Utils:** add dataSerialize and dataDeserialize for iOS ([d2b366d](https://github.com/NativeScript/NativeScript/commit/d2b366dc9c215a069d10a01dfd6fe3ff465fc8dc))
* **Utils:** dataSerialize, dataDeserialize, numberHasDecimals, numberIs64Bit ([0cdc1bf](https://github.com/NativeScript/NativeScript/commit/0cdc1bf91815e9aef7d0985197c387477548fa14))

### Bug Fixes

* **android:** connectivity reporting none on resume ([#9915](https://github.com/NativeScript/NativeScript/issues/9915)) ([8dad6ed](https://github.com/NativeScript/NativeScript/commit/8dad6edbbf642a0247941d871c75032806b970e7))
* **android:** font icons had incorrect fallback size ([#9914](https://github.com/NativeScript/NativeScript/issues/9914)) ([4f312a3](https://github.com/NativeScript/NativeScript/commit/4f312a360ee019ff352637601c0b09b64043bbb1))
* **android:** race condition on offBackgroundColor view change detection ([#9922](https://github.com/NativeScript/NativeScript/issues/9922)) ([24c319e](https://github.com/NativeScript/NativeScript/commit/24c319e3599cf9e0e269d9800827e49dd853f589))
* **android:** Textfield focus fix ([#9885](https://github.com/NativeScript/NativeScript/issues/9885)) ([17a87a4](https://github.com/NativeScript/NativeScript/commit/17a87a4a866e683793d4db8a209cfc1785d9414d))
* **core:** allow View subclass to force onLayoutChangeListener ([#9886](https://github.com/NativeScript/NativeScript/issues/9886)) ([6f68b2f](https://github.com/NativeScript/NativeScript/commit/6f68b2f78dc5994191a5f9a12402d7b2fe9f8041))
* **core:** android fix by hidding current fragment on nav and show on back ([fe8ac02](https://github.com/NativeScript/NativeScript/commit/fe8ac02c82191aec18aff54336061a906212146a))
* **core:** android fix for recreated activity not creating fragments ([84fdbfc](https://github.com/NativeScript/NativeScript/commit/84fdbfc6a6b1b43fd6b1c91826de96d85843fde6))
* **core:** android fix for webview not loading local content ([945d752](https://github.com/NativeScript/NativeScript/commit/945d752dbadc108a98f09fa7e311a038f33b5ea4))
* **core:** android wrong background state + current value accessors ([3e320ca](https://github.com/NativeScript/NativeScript/commit/3e320caa349c35f6f3bd81a953b5104542ea8fee))
* **core:** android wrong background state + current value accessors ([#9883](https://github.com/NativeScript/NativeScript/issues/9883)) ([36e821a](https://github.com/NativeScript/NativeScript/commit/36e821a5b0b8f2717f9dd95aee01047af38d6d0d))
* **core:** animation discover css properties ([2cd8898](https://github.com/NativeScript/NativeScript/commit/2cd889810071be184763746a823b0e7b7645e666))
* **core:** import fix ([04d5f07](https://github.com/NativeScript/NativeScript/commit/04d5f07a56bcc8e0278d619b41d8ec1f04ad8ec3))
* **core:** ios fix where originX and originY would break layout ([ac7470c](https://github.com/NativeScript/NativeScript/commit/ac7470c5fed2f6f4f5264bddf99b968c3fe01b4b))
* **core:** ios release the potential `viewController` ([ca496a5](https://github.com/NativeScript/NativeScript/commit/ca496a57a5a6bf12345bdcc6abc9519046f726aa))
* ensure reusable ProxyViewContainer re-adds native children ([#9882](https://github.com/NativeScript/NativeScript/issues/9882)) ([6e3dd4d](https://github.com/NativeScript/NativeScript/commit/6e3dd4da516988965fd77eb3477cd5556c97db20))
* export 'dataSerialize' from utils ([#9909](https://github.com/NativeScript/NativeScript/issues/9909)) ([710ddae](https://github.com/NativeScript/NativeScript/commit/710ddaed1afe6eb30ad5cb46c6cfc96b914979f7))
* expose `inBackground` and `suspended in `Application` ([13b703a](https://github.com/NativeScript/NativeScript/commit/13b703a3bbde2b77d7919bed19533d67d92cbd8e))
* expose `inBackground` and `suspended in `Application` ([90a0846](https://github.com/NativeScript/NativeScript/commit/90a08462bc451aae3dd2f03d840e5f166abea9a7))
* incorrect font icon size conversion to device pixels. ([#9910](https://github.com/NativeScript/NativeScript/issues/9910)) ([df639ed](https://github.com/NativeScript/NativeScript/commit/df639ed3b205cfef0bef39718493f00692ab45cf))
* **ios:** apply proper border radius to box shadow and view sublayers ([#9881](https://github.com/NativeScript/NativeScript/issues/9881)) ([3d882b0](https://github.com/NativeScript/NativeScript/commit/3d882b0999ca25cbab104700eb483bc5d5d9a1ab))
* **ios:** proper disposal and recreation of iOS native views ([#9879](https://github.com/NativeScript/NativeScript/issues/9879)) ([96a575d](https://github.com/NativeScript/NativeScript/commit/96a575da8cdbbf86995c92704026a3aa910f6191))
* **live-sync:** navigation history is now maintained ([#9889](https://github.com/NativeScript/NativeScript/issues/9889)) ([ae46753](https://github.com/NativeScript/NativeScript/commit/ae467532655ebb6f918d3ac09e9578cd92513989))
* **TabView:** item styling improvements for iOS 15+ ([#9888](https://github.com/NativeScript/NativeScript/issues/9888)) ([b3c5b33](https://github.com/NativeScript/NativeScript/commit/b3c5b33f6a0ea6994eec99976db8c88b75eca74a))
* **ui-mobile-base:** Android http request body was not sent if method was DELETE ([#9887](https://github.com/NativeScript/NativeScript/issues/9887)) ([647ed5c](https://github.com/NativeScript/NativeScript/commit/647ed5cf7d0dc6ef4dccb12e7fd3f70a6c2a4919))
...
* **Utils:** dispatchToUIThread ([4577410](https://github.com/NativeScript/NativeScript/commit/45774103b6522f1487a5fae0dd2950a9dd23cf37))
...
* "fix(ios): apply proper border radius to box shadow and view sublayers ([#9881](https://github.com/NativeScript/NativeScript/issues/9881))" ([#9917](https://github.com/NativeScript/NativeScript/issues/9917)) ([f2e47dd](https://github.com/NativeScript/NativeScript/commit/f2e47dd045155faf3c9296860cda99e695d4f8e4))
...
* **core:** allow View subclass to force onLayoutChangeListener ([8bc9f54](https://github.com/NativeScript/NativeScript/commit/8bc9f547e548c867277507a51372ad1f5a4d1586))
...
* **core:** ios revert broken `lineHeight` ([fd0d6ee](https://github.com/NativeScript/NativeScript/commit/fd0d6ee9870cc4313312246662ae8075f5657761))
* **core:** refactore to prevent Mem Leak ([c7a7139](https://github.com/NativeScript/NativeScript/commit/c7a7139fc3167d17bb29651ad1c29b2384a997da))
* **core:** textfield getting focused again on focus clear ([c2496fd](https://github.com/NativeScript/NativeScript/commit/c2496fd429a954cfb44245496f5f5a2372558e27))
...
* revert breaking change from [#9761](https://github.com/NativeScript/NativeScript/issues/9761) ([e3284a4](https://github.com/NativeScript/NativeScript/commit/e3284a4a8aaebb19e44498b2c4663dcceb186969))
...
* allow better tree shaking ([#9798](https://github.com/NativeScript/NativeScript/issues/9798)) ([d3674de](https://github.com/NativeScript/NativeScript/commit/d3674de88212db48409dd476e5450f4e7d8df0f0))
...
* **webpack:** read nativescript.config.ts main if set before fallback to package.json ([#9769](https://github.com/NativeScript/NativeScript/issues/9769)) ([61ff7e4](https://github.com/NativeScript/NativeScript/commit/61ff7e47622d0464b7f32b1ae7a6df1ce65141de)), closes [#9658](https://github.com/NativeScript/NativeScript/issues/9658)
...
* **android:** if a page transition is cancelled , the end event wont be called. We need to handle it and call `transitionOrAnimationCompleted` ([aef6338](https://github.com/NativeScript/NativeScript/commit/aef6338b304a4c0be7ddf84fe63b57d31cb34d41))
* **core:** add an fix for cancelled transitions stuck in a in-between state ([037bc61](https://github.com/NativeScript/NativeScript/commit/037bc61a3a0a4917691ca13dbe22328530e05d30))
* rollback on last fix ([b592e66](https://github.com/NativeScript/NativeScript/commit/b592e66e9b6602c7b8176a5a8d52bf447519864e))

## 8.1.10 (2022-02-10)

### Bug Fixes

* disable animations for all in between fragments during a transition ([80fe183](https://github.com/NativeScript/NativeScript/commit/80fe1837ac1a4c4d239fa1221adbc0c855e04942))
* use hide to prevent black with OpenGL during a transition ([7933842](https://github.com/NativeScript/NativeScript/commit/79338423e6290eb89b9e1ed786a8f4b7a5f66473))

## 8.1.9 (2022-02-01)

### Bug Fixes

* **android:** suspend fix ([e067111](https://github.com/NativeScript/NativeScript/commit/e067111bbfcee8486f0a8394998f0ed4802ed48f))

## 8.1.8 (2022-02-01)

### Features

* new 'background/foreground` events for app ([16d4338](https://github.com/NativeScript/NativeScript/commit/16d4338f96ad859a03e55a185eeed5958676533b))

### Bug Fixes

* **core:** android fix for entry cleared too late ([663ab77](https://github.com/NativeScript/NativeScript/commit/663ab77a7d358a658d94fa5a71ca5212b1aca329))
* **core:** android fix for tabview error on unload ([eca1a21](https://github.com/NativeScript/NativeScript/commit/eca1a21c4bf0367ea7f5606a8a43b63fbb57f930))

## 8.1.7 (2022-01-29)

### Bug Fixes

* accessibility import fix ([7351200](https://github.com/NativeScript/NativeScript/commit/735120056801dcefb3b937a31de93eb924e2bea7))
* **core:** android fix for `foregroundActivity` not set on first `onNavigatingTo` ([9adb411](https://github.com/NativeScript/NativeScript/commit/9adb411b162cb61af6010db5a20ff6f5fe1e7534))
* **core:** android fix for transitions not starting ([7e5314e](https://github.com/NativeScript/NativeScript/commit/7e5314ef3768c4b4b27377c5f89675218fe972a7))

## 8.1.5 (2022-01-14)

### Bug Fixes

* **android:** version Android text-align justify ([3c049db](https://github.com/NativeScript/NativeScript/commit/3c049dbfa6b724eba775af816281a5406d6d6e81))
* **ios:** box-shadow and border-radius ([#9612](https://github.com/NativeScript/NativeScript/issues/9612)) ([4832179](https://github.com/NativeScript/NativeScript/commit/483217934c679222ed04387421d3a3c7241ae4cf))
* uglify fix ([05393d3](https://github.com/NativeScript/NativeScript/commit/05393d3785abab28501882d4759ebc9240316d51))

## 8.1.5-core (2021-10-28)

### Bug Fixes

* **android:** autofillType on apiLevel < 26 ([b945d5a](https://github.com/NativeScript/NativeScript/commit/b945d5a6651ac89453265954923893d08534a6d0))
...
* allow to disable load of polyfills ([d8ca36a](https://github.com/NativeScript/NativeScript/commit/d8ca36a5aeabcb405ff163ee27b92291de7295d0))
...
* better native-api-usage ([2c7a8f1](https://github.com/NativeScript/NativeScript/commit/2c7a8f1d769cdd0907178c375179a60c7d0ba13f))
* disabled default accessibility ([f7145d9](https://github.com/NativeScript/NativeScript/commit/f7145d9fc29243012707bd4673b3fcf99b8d90b9))
* global __DEV__ variable type ([#9568](https://github.com/NativeScript/NativeScript/issues/9568)) ([61980fd](https://github.com/NativeScript/NativeScript/commit/61980fd4a8573d93ed59348da76e5aca873b2eca))
* **ios:** flat property using new appearance api ([#9558](https://github.com/NativeScript/NativeScript/issues/9558)) ([183b4d4](https://github.com/NativeScript/NativeScript/commit/183b4d4b10a4ec7f9527e5373c8ce723c3db0c3e))
...
* metadata fixes ([4d1d02a](https://github.com/NativeScript/NativeScript/commit/4d1d02ac0eeebffaf135e549dda6ca45b2d671ef))
* missing metadata ([0df4485](https://github.com/NativeScript/NativeScript/commit/0df4485b1eadd0b74cb98d19647d70bf71e6a54f))
* missing native-api-usage ([be5514b](https://github.com/NativeScript/NativeScript/commit/be5514beb0c5d06759345059426dc4bd88845f3c))
* new polyfill for formdata ([53f3219](https://github.com/NativeScript/NativeScript/commit/53f3219b50b73101eccc4b182993d9877838a4e2))
* refactor to only use accessibility when actually used ([709c4bf](https://github.com/NativeScript/NativeScript/commit/709c4bf04e445a01a041cc8d131fe15ae2290c8e))
* replace autofill string in textfield ([#9555](https://github.com/NativeScript/NativeScript/issues/9555)) ([889f6d7](https://github.com/NativeScript/NativeScript/commit/889f6d73cf8bdc080c54387708562d00c2684e9b))
...
* feat: requestLayout performance improvements ([#9122](https://github.com/NativeScript/NativeScript/issues/9122)) ([eb0d000](https://github.com/NativeScript/NativeScript/commit/eb0d000fe15309d80a1edddf0b243c3f88e8bf19))
...
* Frame replacePage by entry ([#9460](https://github.com/NativeScript/NativeScript/issues/9460)) ([ffab4c3](https://github.com/NativeScript/NativeScript/commit/ffab4c31658f9be2137cae5a824f8e8c9bf7aef2)), closes [#9497](https://github.com/NativeScript/NativeScript/issues/9497)

### Bug Fixes

* **ios:** actionitem coloring with 15+ ([86ff418](https://github.com/NativeScript/NativeScript/commit/86ff418166d9963e7380aa69e7ae57a1abc24eb5))

## 8.1.0-alpha.8-core (2021-09-08)

### Bug Fixes

* **modal:** persist modal through configuration changes ([#9533](https://github.com/NativeScript/NativeScript/issues/9533)) ([4632aea](https://github.com/NativeScript/NativeScript/commit/4632aeaae8a21984db59970ead3d932d4c0b1bf0))

### Reverts

* clipsToBounds support ([5532903](https://github.com/NativeScript/NativeScript/commit/5532903ad895c1567f1e6feaa2afcc5569edaf4f))

## 8.1.0-alpha.7-core (2021-09-08)

### Bug Fixes

* **ios:** actionBar title to use appearance api on ios15+ ([#9534](https://github.com/NativeScript/NativeScript/issues/9534)) ([011e869](https://github.com/NativeScript/NativeScript/commit/011e869cd576c80c7d72d7d8bc0eafded3478775))

## 8.1.0-alpha.6-core (2021-09-08)

### Bug Fixes

* **ios:** actionBar to use appearance api on ios13+ ([#9530](https://github.com/NativeScript/NativeScript/issues/9530)) ([2bfccbb](https://github.com/NativeScript/NativeScript/commit/2bfccbbea67261e4bb8f0e5812a7afa104409a05))

## 8.1.0-alpha.5-core (2021-09-08)

### Bug Fixes

* Color.darken fix ([61c3a0a](https://github.com/NativeScript/NativeScript/commit/61c3a0a6670c81d036aad0fb8fff7ef844d1b70b))
* **ios:** resiliency to frame controller viewDidDisappear ([6fc239d](https://github.com/NativeScript/NativeScript/commit/6fc239dc56326b2ee13276537834d2b97ad99fa9))
...
* allow ignoring `reduce-css-calc` w/ webpack without error ([#9510](https://github.com/NativeScript/NativeScript/issues/9510)) ([8c9407c](https://github.com/NativeScript/NativeScript/commit/8c9407c48ed9d4ea416d821586f5d0a6f3f06b6a))
* css colors not parsed correctly within background property ([f554b79](https://github.com/NativeScript/NativeScript/commit/f554b796ef925d7a279c3b41564266d8baf9ef56))
* **ios:** prevent views from being measured if no native view ([#9511](https://github.com/NativeScript/NativeScript/issues/9511)) ([b4dc45e](https://github.com/NativeScript/NativeScript/commit/b4dc45edb35b5bc32dcf24425f64622e6bca2332))
...
* AbortController polyfill ([#9333](https://github.com/NativeScript/NativeScript/issues/9333)) ([58442fb](https://github.com/NativeScript/NativeScript/commit/58442fb454d5933c98aabe6761ce8aa11c6c810b))
* **android:** fragment transactions to use 'add' instead of 'replace' on fwd navigation ([#8791](https://github.com/NativeScript/NativeScript/issues/8791)) ([e17e469](https://github.com/NativeScript/NativeScript/commit/e17e46974b92143f3a1c0a23a94190bff31c735b))
* **android:** provide ability to get registered broadCastReceiver ([#9467](https://github.com/NativeScript/NativeScript/issues/9467)) ([f053001](https://github.com/NativeScript/NativeScript/commit/f053001dc1a3eedb81c5baf984fd40aa1f01d0eb))
* **android:** support clipToBounds ([#9508](https://github.com/NativeScript/NativeScript/issues/9508)) ([1ffc162](https://github.com/NativeScript/NativeScript/commit/1ffc1628d0f9d4b506da3c7c81d97c381ca1d001))
* **android:** vector drawable support ([#9464](https://github.com/NativeScript/NativeScript/issues/9464)) ([76499a5](https://github.com/NativeScript/NativeScript/commit/76499a5367838651d8dcc235d590af21d228a8f9))
* autofillType property for edit text base ([969716e](https://github.com/NativeScript/NativeScript/commit/969716e9f9691e70beedab68303e441089d9be4c))
* autofillType property for edit text base ([#9478](https://github.com/NativeScript/NativeScript/issues/9478)) ([d25cd5b](https://github.com/NativeScript/NativeScript/commit/d25cd5bceea7108fff8bc25e2e9d015fb53fd513))
* **color:** added utilities and improved color parsing performance ([#9110](https://github.com/NativeScript/NativeScript/issues/9110)) ([c4db847](https://github.com/NativeScript/NativeScript/commit/c4db847ded4a8af57fab54530c36daf9cb077570))
* **config:** added option for ignoredNativeDependencies ([65f9598](https://github.com/NativeScript/NativeScript/commit/65f9598a0d016bebf61f89f08d50e9a011d33db0))
* **core:** make css parsers tree-shakable ([#9496](https://github.com/NativeScript/NativeScript/issues/9496)) ([dd5f24a](https://github.com/NativeScript/NativeScript/commit/dd5f24a7377ec5735ec97d929241a5835e719c27))
* **image-source:** add saveToFileAsync, toBase64StringAsync & resizeAsync ([#9404](https://github.com/NativeScript/NativeScript/issues/9404)) ([b2f7923](https://github.com/NativeScript/NativeScript/commit/b2f792324d54139d6ceae14a56136e3a96bb1e94))
* requestLayout performance improvements ([#9122](https://github.com/NativeScript/NativeScript/issues/9122)) ([4f5f0aa](https://github.com/NativeScript/NativeScript/commit/4f5f0aae77dd3b59b8c3856193fdb77b8223262e))
* **webpack:** improved svelte HMR ([#9497](https://github.com/NativeScript/NativeScript/issues/9497)) ([59d9271](https://github.com/NativeScript/NativeScript/commit/59d9271bce1c82486af78f993d034ce412d89cf2))

### Bug Fixes

* allow to ignore `reduce-css-calc` with webpack without error ([785b16a](https://github.com/NativeScript/NativeScript/commit/785b16a642e3d29b4bfdca6352dfb2190e0460bd))
* android support for clipToBounds ([c9e87e8](https://github.com/NativeScript/NativeScript/commit/c9e87e87f9c0d79c92cb6a1ea11a568d491b2028))
* **android:** allow 0-length properties ([#9485](https://github.com/NativeScript/NativeScript/issues/9485)) ([d45dea8](https://github.com/NativeScript/NativeScript/commit/d45dea84710896d53f83e092262f349afa9adc03))
* **android:** do not call exitEvent on activity restart ([#9517](https://github.com/NativeScript/NativeScript/issues/9517)) ([2f630dc](https://github.com/NativeScript/NativeScript/commit/2f630dc464e82a325e10343ee84deb5b666b2bfa))
* **android:** dont dispose fragment on onloaded ([#8793](https://github.com/NativeScript/NativeScript/issues/8793)) ([2dd2970](https://github.com/NativeScript/NativeScript/commit/2dd2970c7d421021203e3342feb7666c3f333b2b))
* **android:** make less calls to native with getters around prop handling ([#9119](https://github.com/NativeScript/NativeScript/issues/9119)) ([a76815b](https://github.com/NativeScript/NativeScript/commit/a76815b81e0dbbcfa9b3ba93e8857d44c4a01c30))
* **android:** onSaveInstanceState should not crash when no rootView is set ([#9447](https://github.com/NativeScript/NativeScript/issues/9447)) ([37c0731](https://github.com/NativeScript/NativeScript/commit/37c0731a8a58cd4cc0a35b69962c1b7cbd464f22))
* **android:** prevent potential crash when app goes to background ([#9347](https://github.com/NativeScript/NativeScript/issues/9347)) ([e7b30af](https://github.com/NativeScript/NativeScript/commit/e7b30af39472371919f364f46a869b68469aac9d))
* **android:** use `nativeTextViewProtected` internally ([#9483](https://github.com/NativeScript/NativeScript/issues/9483)) ([0d0d038](https://github.com/NativeScript/NativeScript/commit/0d0d0382ad238e0df1332506741142e02e01e34c))
* autofillType pre 26 ([8f32241](https://github.com/NativeScript/NativeScript/commit/8f322413eac93925575c1b9482008d2f644191d8))
* color fixes for hsl / hsv ([9664f4b](https://github.com/NativeScript/NativeScript/commit/9664f4b9138ee970fc88e1358f667102e372f751))
* Color.darken fix ([da96e66](https://github.com/NativeScript/NativeScript/commit/da96e661ce191d408748610d2f0f4b509b03a6e1))
* **core:** android broken navigation after go back to root on navDepth > 2 ([c945997](https://github.com/NativeScript/NativeScript/commit/c945997332413b7e8df21abe6b8dca1f4d53b897))
* **core:** correctly export setAutoSystemAppearanceChanged ([#9489](https://github.com/NativeScript/NativeScript/issues/9489)) ([d0f00e2](https://github.com/NativeScript/NativeScript/commit/d0f00e24d8a1b5019e51316e7a3a858ff1835075))
* **core:** prevent iOS views to be measured if no native view ([4e97e71](https://github.com/NativeScript/NativeScript/commit/4e97e71da29d4642c9310b366bfc98ba16ca4d84))
* css colors not parsed correctly within background property ([433053c](https://github.com/NativeScript/NativeScript/commit/433053cf6eefe47b874df3ff24ad765a86ced651))
* css faster color parsing ([2005bd5](https://github.com/NativeScript/NativeScript/commit/2005bd59274c91adfb7f6838fc938fdce82b43ac))
* finally Color.hex should be good ([276b130](https://github.com/NativeScript/NativeScript/commit/276b130ed8eebce1704dd995d34fe394f1667451))
* **frame:** improve weakref guards ([#9518](https://github.com/NativeScript/NativeScript/issues/9518)) ([b7b9d7c](https://github.com/NativeScript/NativeScript/commit/b7b9d7c259a4e970675ebb727f9ffa47a1d80acd))
* hsl/hsv support for css % ([e2f579a](https://github.com/NativeScript/NativeScript/commit/e2f579aa1bcaf2bfe2e03dca37f143a7c542b1ef))
* iOS crash on iOS 14 when onLayout is called without a nativeView ([ae19318](https://github.com/NativeScript/NativeScript/commit/ae193189ae5b11a6f98ca516e96d04fd3b16ff7c))
* **ios:** backgroundColor property on Button ([#9524](https://github.com/NativeScript/NativeScript/issues/9524)) ([c3cadc7](https://github.com/NativeScript/NativeScript/commit/c3cadc7fd5c7afab37daf667227b4d55d7e07196)), closes [NativeScript/NativeScript#9523](https://github.com/NativeScript/NativeScript/issues/9523)
* linear-gradient fix for hex colors with alpha ([02d90f7](https://github.com/NativeScript/NativeScript/commit/02d90f7949c6dc74b71f7ba87fc28c84861594c5))
* **log:** Allow passing optional params for logs ([#9456](https://github.com/NativeScript/NativeScript/issues/9456)) ([7b80094](https://github.com/NativeScript/NativeScript/commit/7b800945ddcec9efa8e7442a7f510913171b2b90))
* more text base fixes for plugins using `nativeTextViewProtected` ([2c8ff31](https://github.com/NativeScript/NativeScript/commit/2c8ff3191c54d3b359486e024c60bfde38805e57))
* some color functions fixes ([ba773c7](https://github.com/NativeScript/NativeScript/commit/ba773c78ae057fc9030cf92377d6fa640bbcba62))
* **styling:** change transform parameters parsing ([#9481](https://github.com/NativeScript/NativeScript/issues/9481)) ([2a45637](https://github.com/NativeScript/NativeScript/commit/2a4563716aa15e4e774b1e033b36a178cf4d51e9)), closes [#5202](https://github.com/NativeScript/NativeScript/issues/5202)
* suspendRequestLayout not being reset to the right state ([46b4b64](https://github.com/NativeScript/NativeScript/commit/46b4b6409fa3b5d113ff0ccedaaa4d251bbcd9f4))
* tsc errors fix ([00b0794](https://github.com/NativeScript/NativeScript/commit/00b07947468017170235fc5fe5a9dd02f7224552))

### Reverts

* feat(android): fragment transactions to use 'add' instead of 'replace' on fwd navigation ([#8791](https://github.com/NativeScript/NativeScript/issues/8791)) ([3e98d1e](https://github.com/NativeScript/NativeScript/commit/3e98d1e93409f9d3d6a6e08f2156662e83234b68))

## 8.0.8-core (2021-06-15)

### Features

* decimal keyboard ([d602d11](https://github.com/NativeScript/NativeScript/commit/d602d112c5d68e1eb9fbd0a12991f92e4c18f540))

### Bug Fixes

* accessibilityIdentifier fix for nativeTextViewProtected ([e42e915](https://github.com/NativeScript/NativeScript/commit/e42e9157c98eb7ef33f77fed034649d5d848c02c))
...
* color hex getter fix ([97a94e8](https://github.com/NativeScript/NativeScript/commit/97a94e82a891a0383eeb0846158428d276db85e6))
...
* **core:** protected class getter/setter webpack issue ([f781242](https://github.com/NativeScript/NativeScript/commit/f781242b9a5a407a8673b0ffb5ae6b49f0750e27))
* **core:** typings issue around Trace.categories.All ([5fd821e](https://github.com/NativeScript/NativeScript/commit/5fd821e5628dcbab280fcf15cb98e49822072d65))

## 8.0.2-core (2021-04-20)

### Features

* abortcontroller pollyfill ([de97f3b](https://github.com/NativeScript/NativeScript/commit/de97f3b4c77d7b88b4743b8106037152019c044f))
* closingModally event ([9618a65](https://github.com/NativeScript/NativeScript/commit/9618a65d86331a76ddfd88a35881cc928d96f921))
...
* allow subclass to override createFormattedTextNative ([ed154b8](https://github.com/NativeScript/NativeScript/commit/ed154b8055ab4f1a3932294f08a444580c2fb596))
* **android:** prevent possible crash when app goes to background ([d551693](https://github.com/NativeScript/NativeScript/commit/d5516937269f3169a6203da8a4f1065b2377993e))
* port boxshadow to background improvements ([3f5ec34](https://github.com/NativeScript/NativeScript/commit/3f5ec3440d8ee1751075bd5d16450c697e6ef244))
...
* **android:** crash with slide transition ([aae9273](https://github.com/NativeScript/NativeScript/commit/aae9273aa25f497d4b1ff53a6a12f4d236f80179))
* **button:** ios let the gesture observer handles tap events ([a2d06a9](https://github.com/NativeScript/NativeScript/commit/a2d06a9efeecc4fbd8f900560eb638863002bb86))
* **color:** support web standard [#rrggbbaa](https://github.com/NativeScript/NativeScript/issues/rrggbbaa) format ([aaeab99](https://github.com/NativeScript/NativeScript/commit/aaeab990c8f73d206bf19e1c918ec45e30d9e3a5)), closes [#ff00ff00](https://github.com/NativeScript/NativeScript/issues/ff00ff00) [#ff00ff00](https://github.com/NativeScript/NativeScript/issues/ff00ff00) [#00ff00](https://github.com/NativeScript/NativeScript/issues/00ff00) [#00ff00](https://github.com/NativeScript/NativeScript/issues/00ff00)
...
* **ios:** incorrect declaration of 'jsArrayToNSArray' and 'nsArrayToJSArray' ([#9277](https://github.com/NativeScript/NativeScript/issues/9277)) ([e9e4934](https://github.com/NativeScript/NativeScript/commit/e9e4934fafdc10fca5892eccb3b40139c414d148))
...
* prevent error if navigationTransition is null or undefined ([56a3f9b](https://github.com/NativeScript/NativeScript/commit/56a3f9bd3cf3d2fe7a81c1fcacbcf822c4154cea))
* RootLayout default open options ([eeb68e9](https://github.com/NativeScript/NativeScript/commit/eeb68e9ce242616cc0d0b05bc5667540fa7bd424))
...
* **android:** NestedScrollView default ScrollBarEnabled is false ([3ce1caa](https://github.com/NativeScript/NativeScript/commit/3ce1caa777575a530f3a8190c113687d5399de47))
* **android:** rewrote the transition system ([a4d7674](https://github.com/NativeScript/NativeScript/commit/a4d7674abaac9f95f91112d0611d4f94eeb543dd))
* **android:** vertical scroll-view now uses NestedScrollView ([5baec25](https://github.com/NativeScript/NativeScript/commit/5baec2579d8b5879080b2a97b91c0c1c0fb7ac46))
* automated tests are now passing ([016313b](https://github.com/NativeScript/NativeScript/commit/016313bef1e139228a8d336c59f7d1d868b302de))
...
* refactor background handling. ([5fc7d1a](https://github.com/NativeScript/NativeScript/commit/5fc7d1a4d4b784c755026cde6105b73cd6a65730))
* refactor background handling. ([d699bf0](https://github.com/NativeScript/NativeScript/commit/d699bf0033d557d67e8f95d5111f651b00b6a58f))
...
* **android:** prevent “flashing” activity on app start ([f80e6c6](https://github.com/NativeScript/NativeScript/commit/f80e6c6be655c3c56be7da664bd2008c2eba478e))
...
* **core:** no need for batchUpdated if no selector ([#9121](https://github.com/NativeScript/NativeScript/issues/9121)) ([3a14a0a](https://github.com/NativeScript/NativeScript/commit/3a14a0a7609e3a63ab204993158c8fd6460422b3))

### Reverts

* perf(core): no need for batchUpdated if no selector ([#9121](https://github.com/NativeScript/NativeScript/issues/9121)) ([4b96d4b](https://github.com/NativeScript/NativeScript/commit/4b96d4baa03d23b0488ec724f123caf2cb81a5f5))

## 7.1.4-core (2021-01-23)

### Bug Fixes

* added the same for didDisappear ([a58baac](https://github.com/NativeScript/NativeScript/commit/a58baac2f18e8b6da8839699f177f1dd9e63fb51))
* all plugins to react on modal page close on ios ([777fdb9](https://github.com/NativeScript/NativeScript/commit/777fdb91b0be2cc05cf0e7b832b073126bb13f3c))
...
* color methods ([44ee97b](https://github.com/NativeScript/NativeScript/commit/44ee97b29d18471afa3185fa4500bdc6f2773f89))
* color methods ([aa2ba2c](https://github.com/NativeScript/NativeScript/commit/aa2ba2c3749e86404663051ee5b62c7988632652))
...
* disableCss property for tests purpose ([4d608f3](https://github.com/NativeScript/NativeScript/commit/4d608f39b8db6ee386801519b176d88172b2d4a3))
...
* global autoRegisterUIModules to disable auto ui registering ([01e9d97](https://github.com/NativeScript/NativeScript/commit/01e9d9706275d65b698e34ae1b5a409282868fe0))
* ios added ignoreSafeArea property ([6f9d052](https://github.com/NativeScript/NativeScript/commit/6f9d0527c0d357f74b29627bebbc1d15a56d8b3e))
* iosIgnoreSafeArea property ([#9092](https://github.com/NativeScript/NativeScript/issues/9092)) ([ea67422](https://github.com/NativeScript/NativeScript/commit/ea67422fcf3106db1359a358e897a63827a642f3))
...
* added Color.mix ([619a3f0](https://github.com/NativeScript/NativeScript/commit/619a3f014fe8d8f0ee0c1decd53ca5d2d861ba9a))
* added Color.mix ([75ceedf](https://github.com/NativeScript/NativeScript/commit/75ceedf1abb44c33d597e971834fa2814f304d54))
...
* **android:** dont create a borderDrawable if not necessary. ([1894944](https://github.com/NativeScript/NativeScript/commit/1894944b41010ce09b6a151d75a2d0cdf23d118f))
* **android:** refactor to make less calls to native ([ce84a20](https://github.com/NativeScript/NativeScript/commit/ce84a200b0225e1fc09a2fda4cb74c5a4e1ac8cd))
* **android:** when possible only call setBackgroundColor ([96fac04](https://github.com/NativeScript/NativeScript/commit/96fac04dd98327f88a9140c98f7be6c1057cba10))
...
* **core:** prevent circular reference Frame <> Page ([#9111](https://github.com/NativeScript/NativeScript/issues/9111)) ([9a380cd](https://github.com/NativeScript/NativeScript/commit/9a380cd43e2ebff852155647e83b803b82a8a94b))
* default view to clickable so touches dont get “passed through” ([8aa2ef8](https://github.com/NativeScript/NativeScript/commit/8aa2ef867c5e5b271f3a020152e101be3b051933))
* ensure it works when no viewControllerView ([ee544d7](https://github.com/NativeScript/NativeScript/commit/ee544d788575a5ffef1a5555f12d6b58c7ea78a3))
* ensure we dont get udplicates in oldProperties and newPropertyValues ([ca1c9f2](https://github.com/NativeScript/NativeScript/commit/ca1c9f25197ed2cada297187bfeac1ef6cc956aa))
* ensure we dont get udplicates in oldProperties and newPropertyValues ([512c552](https://github.com/NativeScript/NativeScript/commit/512c552b5be05295695b2f7b920d6dc653b4c2ed))
* faster colors handling ([bb4468b](https://github.com/NativeScript/NativeScript/commit/bb4468ba1e06a0f719bae8da17aa5baf5e93a795))
* first pass at improving requestLayout ([1582f6c](https://github.com/NativeScript/NativeScript/commit/1582f6c035b424f428aeb8d0ec101841f78f917f))
* fix regression after colors simplifications ([5a61587](https://github.com/NativeScript/NativeScript/commit/5a6158768d4fe30439de9f4e91da5914daacddb7))
* fix regression after colors simplifications ([9609989](https://github.com/NativeScript/NativeScript/commit/96099892ba83d28062997707a2f3150acabacc91))
* fix tsc errors ([407d57f](https://github.com/NativeScript/NativeScript/commit/407d57ff6244919d0668121ac5ad26f02e40b6e1))
* improve Color performances. ([4ef99ab](https://github.com/NativeScript/NativeScript/commit/4ef99ab64fdcb75345b07e38bf1edd07db042132))
* improve Color performances. ([427001a](https://github.com/NativeScript/NativeScript/commit/427001a5a4c4b8e7bfb8bf2840870d8f15725325))
...
* make object optional in notify ([4033367](https://github.com/NativeScript/NativeScript/commit/40333670b42bd895222ff525c7e1c1b023250f84))
* missing mix color typings ([2c59024](https://github.com/NativeScript/NativeScript/commit/2c59024507f7b689181ba4dfb11e385c1852ff5c))
* missing mix color typings ([b6b36cf](https://github.com/NativeScript/NativeScript/commit/b6b36cf943243a9756b93c5a14db837a00574680))
* more rollbacks ([22e686d](https://github.com/NativeScript/NativeScript/commit/22e686d09827482bc12f2da710be948d75d83afb))
* no need for batchUdated if no selector ([1c85549](https://github.com/NativeScript/NativeScript/commit/1c85549ed3acbb6eb93bab3d866f046f308c65e4))
* only require parsers if need be ([17658ed](https://github.com/NativeScript/NativeScript/commit/17658ed7770926c382e4794bb96142554d83af43))
* prevent circular reference && Cannot access … before initialization ([3accdb3](https://github.com/NativeScript/NativeScript/commit/3accdb3f067157d45c88e58e2cca924afe7bd2c6))
* Prior PR ([#8904](https://github.com/NativeScript/NativeScript/issues/8904)) has bad path for trace modules ([1a849f9](https://github.com/NativeScript/NativeScript/commit/1a849f93028c6936d978956541093fdc644f794c))
* rollback animation lint which would break promise context ([b85d0e5](https://github.com/NativeScript/NativeScript/commit/b85d0e5ee3ed71cfc59c3f3cecbd137772c74f33))
* rollback regexp eslint changes ([ca56a30](https://github.com/NativeScript/NativeScript/commit/ca56a30d56e70bbeded27745e92758f81063c06a))
* rollback regexp eslint changes ([#9028](https://github.com/NativeScript/NativeScript/issues/9028)) ([6902770](https://github.com/NativeScript/NativeScript/commit/6902770d90213016d61ca465c1198c37672e1b8b))
...
* tslib broken in 2.0.3 ([5b782ff](https://github.com/NativeScript/NativeScript/commit/5b782ffb2e81879b915601d02b0ce0adab2949fd))
* typo fix ([328feeb](https://github.com/NativeScript/NativeScript/commit/328feeb9c13fa36fb5da6add5aaaf3032a5bf633))

### Performance Improvements

* faster color parsing ([#9001](https://github.com/NativeScript/NativeScript/issues/9001)) ([c569236](https://github.com/NativeScript/NativeScript/commit/c5692363575821ef588b2260e80ad5bbffe45293))
...
* android cleanup after new fragment handling ([e6fc878](https://github.com/NativeScript/NativeScript/commit/e6fc8784e10187be2365f78fbab0dd9618b79645))
* android default modal animation ([67ee01e](https://github.com/NativeScript/NativeScript/commit/67ee01e5fefec3cb90bed4a86b4b3ca9ce2ef1f2))
...
* **android:** make findPageForFragment with fragmen add/remove ([17ddbbb](https://github.com/NativeScript/NativeScript/commit/17ddbbb9c1551b79658179770d3030f7063c326c))
...
* emitDecoratorMetadata fix ([2c4a77b](https://github.com/NativeScript/NativeScript/commit/2c4a77bde0baec72ddd54e34e39a5a9c7e25c9d2))
* fix grid layout animation ([34e9617](https://github.com/NativeScript/NativeScript/commit/34e9617162ba0c62f2226fab20eb7afdb12b7b93))
...
* **core:** autoSystemAppearanceChanged typings in ambient context fix ([08b3caf](https://github.com/NativeScript/NativeScript/commit/08b3cafb543a2eae3bb078b5fc6b077fb9b1561c))
* **core:** bundle-config-loader global handling ([#8838](https://github.com/NativeScript/NativeScript/issues/8838)) ([bd00e1f](https://github.com/NativeScript/NativeScript/commit/bd00e1fa87093889b10e63302a40e1ecdbdaaa5c))
...
* boolean to disable systemAppearanceChanged (theme) ([b8df0b3](https://github.com/NativeScript/NativeScript/commit/b8df0b3ac051a3e4437e87ed87c9659652255e6c))
...
* **android:** dont dispose fragment on onloaded ([3fbeace](https://github.com/NativeScript/NativeScript/commit/3fbeacec41ff5068d1395e4366dda8ee65539321))
...
* need to be a function to work ([43f1d50](https://github.com/NativeScript/NativeScript/commit/43f1d50a36fb337148b355670b1b880537034c97))
