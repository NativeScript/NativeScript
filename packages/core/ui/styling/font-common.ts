...
export abstract class Font implements FontDefinition {
	...
	protected constructor(public readonly fontFamily: string, public readonly fontSize: number, public readonly fontStyle: FontStyleType, public readonly fontWeight: FontWeightType) {}
