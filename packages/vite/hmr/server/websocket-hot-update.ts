...
import { collectAngularEvictionUrls, collectAngularHotUpdateRoots, collectAngularTransformCacheInvalidationUrls, collectGraphUpdateModulesForHotUpdate, shouldInvalidateAngularTransitiveImporters, shouldSuppressDefaultViteHotUpdate, type HotUpdateGraphModuleLike } from '../frameworks/angular/server/websocket-angular-hot-update.js';
import { canonicalizeTransformRequestCacheKey, collectAngularTransitiveImportersForInvalidation, type TransitiveImporterModuleLike } from './transform-cache-invalidation.js';
