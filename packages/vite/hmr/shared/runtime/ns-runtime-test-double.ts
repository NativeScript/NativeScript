/**
 * TEST-ONLY. A stand-in for the runtime's `ns:runtime` builtin module.
 *
 * On device the dev host API is resolved with `require("ns:runtime")`
...
/**
 * Stub `scope.require` to resolve `ns:runtime` to a fresh mutable module
