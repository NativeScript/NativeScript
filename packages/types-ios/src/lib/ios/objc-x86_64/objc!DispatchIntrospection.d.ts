 ...
 * @since 7.0
 */
declare function dispatch_introspection_hook_queue_callout_begin(queue: NSObject & OS_dispatch_queue, context: interop.Pointer | interop.Reference<any> | ArrayBufferLike | ArrayBufferView | null, _function: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any> | null) => void>): void;

/**
 * @since 7.0
 */
declare function dispatch_introspection_hook_queue_callout_end(queue: NSObject & OS_dispatch_queue, context: interop.Pointer | interop.Reference<any> | ArrayBufferLike | ArrayBufferView | null, _function: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any> | null) => void>): void;
