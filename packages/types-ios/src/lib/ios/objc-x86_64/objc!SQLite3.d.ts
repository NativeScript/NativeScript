...
interface Fts5ExtensionApi {
	...
	xColumnText: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<any>, p2: number, p3: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<any>>, p4: interop.Pointer | interop.Reference<number>) => number>;
...
interface Fts5PhraseIter {
	a: interop.Pointer | interop.Reference<any>;
	b: interop.Pointer | interop.Reference<any>;
}
 ...
 * @since 15.0
 */
declare function sqlite3_normalized_sql(pStmt: interop.Pointer | interop.Reference<any>): interop.Pointer | interop.Reference<any>;
