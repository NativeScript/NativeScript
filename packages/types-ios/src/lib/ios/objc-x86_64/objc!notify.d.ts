 ...
 * @since 3.2
 */
declare function notify_register_dispatch(name: string | interop.Pointer | interop.Reference<any>, out_token: interop.Pointer | interop.Reference<number>, queue: NSObject & OS_dispatch_queue, handler: (p1: number) => void): number;
