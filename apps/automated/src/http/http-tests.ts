...
import type { BaseHttpContent } from '@nativescript/core/http/http-request-internal';
import { requestInternal, addHeader } from '@nativescript/core/http/http-request-internal';
