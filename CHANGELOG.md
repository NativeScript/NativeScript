...
### Fixed
- [(# 4963)](https://github.com/NativeScript/NativeScript/pull/4963) Fix missing borderRadius on Image in iOS
- [(# 4959)](https://github.com/NativeScript/NativeScript/pull/4959) Android: Fix ConstantState drawable related crash on API 23
- [(# 4950)](https://github.com/NativeScript/NativeScript/issues/4950) Crash on android when application is suspended
- [(# 4897)](https://github.com/NativeScript/NativeScript/issues/4897) Button listener missing owner
- [(# 4895)](https://github.com/NativeScript/NativeScript/issues/4895) Default page transtion in app.ts is not working for the initial page & breaks navigation
- [(# 4851)](https://github.com/NativeScript/NativeScript/issues/4851) Android: DatePicker shows wrong month
- [(# 4740)](https://github.com/NativeScript/NativeScript/issues/4740) Button:highlighted stops working after 2nd click
...
- [(# 4922)](https://github.com/NativeScript/NativeScript/pull/4922) Updated platform declarations to ios 11
