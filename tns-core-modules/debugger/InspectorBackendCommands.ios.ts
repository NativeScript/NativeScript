...
export interface HeapDomainDispatcher { 
	...
	getPreview(params: GetPreviewMethodArguments): { string?: string, functionDetails?: DebuggerDomain.FunctionDetails, preview?: RuntimeDomain.ObjectPreview };
...
export interface CSSDomainDispatcher { 
	...
	getMatchedStylesForNode(params: GetMatchedStylesForNodeMethodArguments): { inlineStyle?: CSSStyle, attributesStyle?: CSSStyle, matchedCSSRules?: RuleMatch[], pseudoElements?: PseudoElementMatches[], inherited?: InheritedStyleEntry[], cssKeyframesRules?: CSSKeyframesRule[] };
