 ...
 */
export function setTimeout(callback: Function, milliseconds?: number | boolean,  ...args: any[]): number;
 ...
 * @param args One or more parameter to use once the function is called. Defaults to no parameters.
 */
export function setInterval(callback: Function, milliseconds?: number | boolean,  ...args: any[]): number;
