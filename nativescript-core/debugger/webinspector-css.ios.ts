...
export class CSSDomainDebugger
	implements inspectorCommandTypes.CSSDomain.CSSDomainDispatcher {
	...
	getComputedStyleForNode(
		...
		return {
			computedStyle: this.commands.getComputedStylesForNode(
				params.nodeId
			),
		};
	}
	...
	getPlatformFontsForNode(
		params: inspectorCommandTypes.CSSDomain.GetPlatformFontsForNodeMethodArguments
	...
	getStyleSheetText(
		params: inspectorCommandTypes.CSSDomain.GetStyleSheetTextMethodArguments
	): { text: string } {
		return null;
	}
}
