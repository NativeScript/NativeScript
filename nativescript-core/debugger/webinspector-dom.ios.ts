...
import {
	attachDOMInspectorEventCallbacks,
	attachDOMInspectorCommandCallbacks,
} from "./devtools-elements";

@inspectorCommands.DomainDispatcher("DOM")
export class DOMDomainDebugger
	implements inspectorCommandTypes.DOMDomain.DOMDomainDispatcher {
	...
	removeNode(
		params: inspectorCommandTypes.DOMDomain.RemoveNodeMethodArguments
	): void {
		this.commands.removeNode(params.nodeId);
	}

	setAttributeValue(
		params: inspectorCommandTypes.DOMDomain.SetAttributeValueMethodArguments
	): void {
		throw new Error("Method not implemented.");
	}

	setAttributesAsText(
		params: inspectorCommandTypes.DOMDomain.SetAttributesAsTextMethodArguments
	): void {
		this.commands.setAttributeAsText(
			params.nodeId,
			params.text,
			params.name
		);
	...
	performSearch(
		params: inspectorCommandTypes.DOMDomain.PerformSearchMethodArguments
	): { searchId: string; resultCount: number } {
		return null;
	}

	getSearchResults(
		params: inspectorCommandTypes.DOMDomain.GetSearchResultsMethodArguments
	): { nodeIds: inspectorCommandTypes.DOMDomain.NodeId[] } {
		return null;
	}

	discardSearchResults(
		params: inspectorCommandTypes.DOMDomain.DiscardSearchResultsMethodArguments
	): void {
		return;
	}

	highlightNode(
		params: inspectorCommandTypes.DOMDomain.HighlightNodeMethodArguments
	): void {
		return;
	}
	...
	resolveNode(
		params: inspectorCommandTypes.DOMDomain.ResolveNodeMethodArguments
