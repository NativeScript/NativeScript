...
export class Label extends TextBase implements LabelDefinition {
	...
	private _measureNativeView(
		...
		nativeSize.width = layout.round(
			layout.toDevicePixels(nativeSize.width)
		);
		nativeSize.height = layout.round(
	...
	[borderRightWidthProperty.setNative](value: Length) {
		...
		nativeView.borderThickness = {
			top: border.top,
			right: layout.toDeviceIndependentPixels(
	...
	[borderBottomWidthProperty.setNative](value: Length) {
		...
		nativeView.borderThickness = {
			top: border.top,
			right: border.right,
			bottom: layout.toDeviceIndependentPixels(
	...
	[borderLeftWidthProperty.setNative](value: Length) {
		...
		nativeView.borderThickness = {
			...
			right: border.right,
			bottom: border.bottom,
			left: layout.toDeviceIndependentPixels(
