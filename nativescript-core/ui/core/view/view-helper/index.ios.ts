...
export namespace IOSHelper {
    ...
    export function layoutView(controller: UIViewController, owner: View): void {
        ...
        if (!layoutGuide) {
            Trace.write(`safeAreaLayoutGuide during layout of ${owner}. Creating fallback constraints, but layout might be wrong.`,
                Trace.categories.Layout, Trace.messageType.error);
