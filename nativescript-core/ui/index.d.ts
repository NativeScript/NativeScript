...
export declare const nsBuilder: {
    createViewFromEntry: typeof createViewFromEntry;
    load: typeof load;
    parse: typeof parse;
    parseMultipleTemplates: typeof parseMultipleTemplates;
};
...
export declare const nsDialogs: {
...
export declare const nsFrame: {
    topmost: typeof topmost;
