...
export class TabStripItem extends View
	implements TabStripItemDefinition, AddChildFromBuilder {
	...
	public onLoaded() {
		...
		this._labelColorHandler =
			...
			((args: PropertyChangeData) => {
				...
				const tabStripParent =
					parent && <TabNavigationBase>parent.parent;

				return (
					tabStripParent &&
					tabStripParent.setTabBarItemColor(this, args.value)
				);
			});
		...
		this._labelFontHandler =
			...
			((args: PropertyChangeData) => {
				...
				return (
					tabStripParent &&
					tabStripParent.setTabBarItemFontInternal(this, args.value)
				);
			});
		...
		this._labelTextTransformHandler =
			...
			((args: PropertyChangeData) => {
				...
				return (
					tabStripParent &&
					tabStripParent.setTabBarItemTextTransform(this, args.value)
				);
			});
		this.label.style.on(
			"textTransformChange",
		...
		this._labelTextHandler =
			...
			((args: PropertyChangeData) => {
				...
				return (
					tabStripParent &&
					tabStripParent.setTabBarItemTitle(this, args.value)
				);
			});
		...
		this._imageColorHandler =
			...
			((args: PropertyChangeData) => {
				...
				return (
					tabStripParent &&
					tabStripParent.setTabBarIconColor(this, args.value)
				);
			});
		...
		this._imageSrcHandler =
			...
			((args: PropertyChangeData) => {
				...
				return (
					tabStripParent &&
					tabStripParent.setTabBarIconSource(this, args.value)
				);
			});
	...
	[backgroundColorProperty.setNative](value: Color) {
		...
		return (
			tabStripParent &&
			tabStripParent.setTabBarItemBackgroundColor(this, value)
		);
	}
	...
	[textTransformProperty.getDefault](): TextTransform {
		...
		return (
			tabStripParent && tabStripParent.getTabBarItemTextTransform(this)
		);
	}
	[textTransformProperty.setNative](value: TextTransform) {
		...
		return (
			tabStripParent &&
			tabStripParent.setTabBarItemTextTransform(this, value)
		);
	}
