...
export class TabStrip extends View
	implements TabStripDefinition, AddChildFromBuilder, AddArrayFromBuilder {
	...
	public onItemsChanged(
		oldItems: TabStripItem[],
		newItems: TabStripItem[]
	): void {
		if (oldItems) {
...
export interface TabStrip {
	...
	on(
		event: "itemTap",
		callback: (args: TabStripItemEventData) => void,
		thisArg?: any
	);
}
