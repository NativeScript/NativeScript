import {
	GridLayout as GridLayoutDefinition,
	ItemSpec as ItemSpecDefinition,
} from ".";
...
function parseAndAddItemSpecs(
	value: string,
	func: (itemSpec: ItemSpec) => void
): void {
