...
function makeNativeSetter<T>(
	setter: (
		this: View,
		lp: org.nativescript.widgets.CommonLayoutParams,
		value: T
	) => void
) {
...
View.prototype[topProperty.setNative] = makeNativeSetter<number>(function (
	this: View,
	lp,
	value
) {
...
View.prototype[leftProperty.setNative] = makeNativeSetter<number>(function (
	this: View,
	lp,
	value
) {
