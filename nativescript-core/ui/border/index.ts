...
export class Border extends ContentView implements BorderDefinition {
  ...
  public onMeasure(widthMeasureSpec: number, heightMeasureSpec: number): void {
    ...
    const result = View.measureChild(this, this.layoutView, layout.makeMeasureSpec(width - horizontalBorderLength, widthMode), layout.makeMeasureSpec(height - verticalBorderLength, heightMode));
