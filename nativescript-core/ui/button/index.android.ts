...
export class Button extends ButtonBase {
	...
	public resetNativeView(): void {
		...
		if (this._stateListAnimator && APILEVEL >= 21) {
			(<any>this.nativeViewProtected).setStateListAnimator(
				this._stateListAnimator
			);
	...
	[minWidthProperty.getDefault](): Length {
		const dips = org.nativescript.widgets.ViewHelper.getMinWidth(
	...
	[minHeightProperty.getDefault](): Length {
		const dips = org.nativescript.widgets.ViewHelper.getMinHeight(
			this.nativeViewProtected
		);
