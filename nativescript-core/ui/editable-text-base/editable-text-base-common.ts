import {
	EditableTextBase as EditableTextBaseDefinition,
	KeyboardType,
	ReturnKeyType,
	UpdateTextTrigger,
...
export abstract class EditableTextBase extends TextBase
	implements EditableTextBaseDefinition {
...
const keyboardTypeConverter = makeParser<KeyboardType>(
	makeValidator<KeyboardType>(
		"datetime",
		"phone",
		"number",
		"url",
...
export const keyboardTypeProperty = new Property<
	EditableTextBase,
	KeyboardType
>({ name: "keyboardType", valueConverter: keyboardTypeConverter });
keyboardTypeProperty.register(EditableTextBase);

const returnKeyTypeConverter = makeParser<ReturnKeyType>(
	makeValidator<ReturnKeyType>("done", "next", "go", "search", "send")
);
...
export const updateTextTriggerProperty = new Property<
	EditableTextBase,
	UpdateTextTrigger
>({ name: "updateTextTrigger", defaultValue: "textChanged" });
updateTextTriggerProperty.register(EditableTextBase);

const autocapitalizationTypeConverter = makeParser<AutocapitalizationType>(
	makeValidator<AutocapitalizationType>(
		"none",
		"words",
		"sentences",
		"allcharacters"
