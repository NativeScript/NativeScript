...
export class PageBase extends ContentView implements PageDefinition {
	...
	public onNavigatingTo(
		...
		this.notify(
			this.createNavigatedData(
				PageBase.navigatingToEvent,
				isBackNavigation
			)
		);
	}
