...
function initializeNativeClasses(): void {
	...
	class TabChangeListenerImpl extends java.lang.Object
	...
	class TabContentFactoryImpl extends java.lang.Object
...
export class SegmentedBarItem extends SegmentedBarItemBase {
	...
	public setupNativeView(tabIndex: number): void {
		...
		const titleTextView = <android.widget.TextView>(
	...
	[selectedBackgroundColorProperty.getDefault](): android.graphics.drawable.Drawable {
		const viewGroup = <android.view.ViewGroup>(
			this.nativeViewProtected.getParent()
		);

		return viewGroup.getBackground();
	}
	[selectedBackgroundColorProperty.setNative](
		value: Color | android.graphics.drawable.Drawable
	) {
		...
		if (value instanceof Color) {
			...
			if (apiLevel > 21 && backgroundDrawable) {
				...
				const colorDrawable: android.graphics.drawable.ColorDrawable = new org.nativescript.widgets.SegmentedBarColorDrawable(
					color,
			...
			const backgroundDrawable = tryCloneDrawable(
				value,
				nativeView.getResources()
			);
