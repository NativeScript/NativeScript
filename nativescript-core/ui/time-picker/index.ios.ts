...
function getComponents(date: Date | NSDate): NSDateComponents {
	return NSCalendar.currentCalendar.componentsFromDate(
...
class UITimePickerChangeHandlerImpl extends NSObject {
	...
	public static initWithOwner(
		owner: WeakRef<TimePicker>
	): UITimePickerChangeHandlerImpl {
		let handler = <UITimePickerChangeHandlerImpl>(
			UITimePickerChangeHandlerImpl.new()
		);
