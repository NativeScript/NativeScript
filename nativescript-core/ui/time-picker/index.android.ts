...
function initializeTimeChangedListener(): void {
	...
	class TimeChangedListenerImpl extends java.lang.Object
		...
		onTimeChanged(
			picker: android.widget.TimePicker,
			hour: number,
			minute: number
		): void {
			...
			timeProperty.nativeValueChange(
				timePicker,
...
export class TimePicker extends TimePickerBase {
	...
	public initNativeView(): void {
		...
		const hour = hourProperty.isSet(this)
			? this.hour
			: calendar.get(java.util.Calendar.HOUR_OF_DAY);
		const minute = minuteProperty.isSet(this)
			? this.minute
	...
	[minuteProperty.setNative](value: number) {
		...
		try {
			if (apiLevel >= 23) {
				...
				this.nativeViewProtected.setCurrentMinute(
	...
	[hourProperty.setNative](value: number) {
		...
		try {
			if (apiLevel >= 23) {
				...
				this.nativeViewProtected.setCurrentHour(
					new java.lang.Integer(value)
				);
			}
		} finally {
