import {
	TabView as TabViewDefinition,
	TabViewItem as TabViewItemDefinition,
...
@CSSType("TabViewItem")
export abstract class TabViewItemBase extends ViewBase
	implements TabViewItemDefinition, AddChildFromBuilder {
...
@CSSType("TabView")
export class TabViewBase extends View
	implements TabViewDefinition, AddChildFromBuilder, AddArrayFromBuilder {
	...
	public onItemsChanged(
		oldItems: TabViewItemDefinition[],
		newItems: TabViewItemDefinition[]
	): void {
		if (oldItems) {
...
>({ name: "iosIconRenderingMode", defaultValue: "automatic" });
...
export const androidTabsPositionProperty = new Property<
	TabViewBase,
	"top" | "bottom"
>({ name: "androidTabsPosition", defaultValue: "top" });
