...
class UIGestureRecognizerDelegateImpl extends NSObject
  implements UIGestureRecognizerDelegate {
  public static ObjCProtocols = [UIGestureRecognizerDelegate];

  public gestureRecognizerShouldRecognizeSimultaneouslyWithGestureRecognizer(
  ...
  public gestureRecognizerShouldRequireFailureOfGestureRecognizer(
    gestureRecognizer: UIGestureRecognizer,
    otherGestureRecognizer: UIGestureRecognizer
  ): boolean {
...
let recognizerDelegateInstance: UIGestureRecognizerDelegateImpl = <
  UIGestureRecognizerDelegateImpl
>UIGestureRecognizerDelegateImpl.new();
...
class UIGestureRecognizerImpl extends NSObject {
  ...
  public static initWithOwnerTypeCallback(
    owner: WeakRef<GesturesObserver>,
    type: any,
    callback?: Function,
    thisArg?: any
...
export class GesturesObserver extends GesturesObserverBase {
  ...
  private _createRecognizer(
    type: GestureTypes,
    callback?: (args: GestureEventData) => void,
    swipeDirection?: UISwipeGestureRecognizerDirection
  ): UIGestureRecognizer {
    let recognizer: UIGestureRecognizer;
    let name = toString(type);
    const target = _createUIGestureRecognizerTarget(
      this,
      type,
      callback,
      this.context
...
class Pointer implements Pointer {
  ...
  getX(): number {
    return this.location.x / layout.getDisplayDensity();
  }

  getY(): number {
    return this.location.y / layout.getDisplayDensity();
  }
}
...
class TouchGestureEventData implements TouchGestureEventData {
  ...
  getActivePointers(): Array<Pointer> {
    if (!this._activePointers) {
      ...
      for (
        let i = 0, nsArr = this.ios.touches.allObjects;
        i < nsArr.count;
        i++
      ) {
