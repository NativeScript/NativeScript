...
function initializeTapAndDoubleTapGestureListener() {
  ...
  class TapAndDoubleTapGestureListenerImpl extends android.view.GestureDetector
...
function initializePinchGestureListener() {
  ...
  class PinchGestureListenerImpl extends android.view.ScaleGestureDetector
...
function initializeSwipeGestureListener() {
  ...
  class SwipeGestureListenerImpl extends android.view.GestureDetector
    .SimpleOnGestureListener {
    private _observer: GesturesObserver;
    private _target: View;
...
class CustomPanGestureDetector {
  ...
  private trackStart(currentEvent: android.view.MotionEvent) {
    let inital = this.getEventCoordinates(
