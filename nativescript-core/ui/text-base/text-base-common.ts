...
export abstract class TextBaseCommon extends View
	implements TextBaseDefinition {
...
function onFormattedTextPropertyChanged(
	textBase: TextBaseCommon,
	oldValue: FormattedString,
...
export function getClosestPropertyValue<T>(
	property: CssProperty<any, T>,
	span: Span
): T {
...
const textTransformConverter = makeParser<TextTransform>(
	makeValidator<TextTransform>(
		"initial",
		"none",
		"capitalize",
		"uppercase",
...
const whiteSpaceConverter = makeParser<WhiteSpace>(
	makeValidator<WhiteSpace>("initial", "normal", "nowrap")
);
...
const textDecorationConverter = makeParser<TextDecoration>(
	makeValidator<TextDecoration>(
		"none",
		"underline",
		"line-through",
