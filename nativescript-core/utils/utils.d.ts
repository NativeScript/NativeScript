...
export module ad {
	...
	export function dismissSoftInput(
		nativeView?: any /* android.view.View */
	): void;

	/**
	 * Shows the soft input method, usually a soft keyboard.
	 */
	export function showSoftInput(
		nativeView: any /* android.view.View */
	): void;
...
export module ios {
	...
	export function getVisibleViewController(
		rootViewController: any /* UIViewController*/
 ...
 */
export function releaseNativeObject(
	object: any /*java.lang.Object | NSObject*/
);
