if (global.TNS_WEBPACK) {
	...
	global.registerModule("ui/text-base/formatted-string", () =>
		require("./ui/text-base/formatted-string")
	);
	global.registerModule("ui/text-base/span", () =>
		require("./ui/text-base/span")
	);
	global.registerModule("ui/action-bar", () => require("./ui/action-bar"));
	global.registerModule("ui/activity-indicator", () =>
		require("./ui/activity-indicator")
	);
	global.registerModule("ui/border", () => require("./ui/border"));
	global.registerModule("ui/bottom-navigation", () =>
		require("./ui/bottom-navigation")
	);
	...
	global.registerModule("ui/layouts/absolute-layout", () =>
		require("./ui/layouts/absolute-layout")
	);
	global.registerModule("ui/layouts/dock-layout", () =>
	...
	global.registerModule("ui/layouts/flexbox-layout", () =>
		require("./ui/layouts/flexbox-layout")
	);
	global.registerModule("ui/layouts/wrap-layout", () =>
	...
	global.registerModule("ui/proxy-view-container", () =>
	...
	global.registerModule("ui/segmented-bar", () =>
	...
	global.registerModule("ui/tab-navigation-base/tab-strip", () =>
		require("./ui/tab-navigation-base/tab-strip")
	);
	global.registerModule("ui/tab-navigation-base/tab-strip-item", () =>
		require("./ui/tab-navigation-base/tab-strip-item")
	);
	global.registerModule("ui/tab-navigation-base/tab-content-item", () =>
		require("./ui/tab-navigation-base/tab-content-item")
	);
