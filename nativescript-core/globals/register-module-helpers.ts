...
const modules: Map<
	string,
	{ moduleId: string; loader: ModuleLoader }
> = new Map<string, { moduleId: string; loader: ModuleLoader }>();
...
global._isModuleLoadedForUI = function _isModuleLoadedForUI(
	moduleName: string
): boolean {
...
global.loadModule = function loadModule(
	name: string,
